-- chunkname: @C:\\Users\\dev02\\Desktop\\Customized KR5\\Kingdom Rush Alliance\\kr5\\data\\levels\\level117_data.lua
	...
	entities_list = {
		{
			...
			["render.sprites[1].name"] = "stage117_wall_bottom_",
			pos = {
				x = 1180,
				y = 182
			},
		...
		},
		{
			...
			["render.sprites[1].name"] = "stage_117",
			pos = {
				x = 512,
				y = 384
			}
		},
		{
			...
			template = "decal_background",
			["render.sprites[1].z"] = 3000,
			["render.sprites[1].name"] = "stage117_wall_top",
			pos = {
				x = 1149,
				y = 415
			},
