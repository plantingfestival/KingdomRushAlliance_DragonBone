-- chunkname: @C:\\Users\\dev02\\Desktop\\Customized KR5\\Kingdom Rush Alliance\\kr5\\data\\tower_menus_data.lua
...
return {
	holder = {
		{
			...
			{
				check = "main_icons_0019",
				action_arg = "tower_build_viper_goblins",
				action = "tw_upgrade",
				type = "viper_goblins",
				halo = "glow_ico_main",
				image = "main_icons_0100",
				preview = "archer",
				tt_title = _("TOWER_VIPER_GOBLINS_1_NAME"),
				tt_desc = _("TOWER_VIPER_GOBLINS_1_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
			...
			{
				check = "main_icons_0019",
				action_arg = "tower_build_elder_portal",
				action = "tw_upgrade",
				type = "elder_portal",
				halo = "glow_ico_main",
				image = "main_icons_0112",
				preview = "elder_portal",
				tt_title = _("TOWER_ELDER_PORTAL_1_NAME"),
				tt_desc = _("TOWER_ELDER_PORTAL_1_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
			...
			{
				check = "main_icons_0019",
				action_arg = "tower_build_warmongers_barrack",
				action = "tw_upgrade",
				type = "warmongers_barrack",
				halo = "glow_ico_main",
				image = "tower_icons_0125",
				preview = "warmongers_barrack",
				tt_title = _("TOWER_WARMONGERS_BARRACK_LVL1_NAME"),
				tt_desc = _("TOWER_WARMONGERS_BARRACK_LVL1_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
				...
				type = "ignis_altar",
				halo = "glow_ico_main",
				image = "tower_icons_0132",
				preview = "ignis_altar",
				tt_title = _("TOWER_IGNIS_ALTAR_LVL1_NAME"),
				tt_desc = _("TOWER_IGNIS_ALTAR_LVL1_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
			...
			},
			{
				...
				type = "random",
				halo = "glow_ico_main",
				image = "tower_icons_0127",
				preview = "random",
				tt_title = _("TOWER_RANDOM_NAME"),
				tt_desc = _("TOWER_RANDOM_DESC")
			}
		}
	},
	...
	paladin_covenant = {
		...
		},
		{
			...
			},
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_wildling",
				halo = "glow_ico_main",
				image = "tower_icons_0101",
				place = 3,
				tt_title = _("TOWER_WILDLING_NAME"),
				tt_desc = _("TOWER_WILDLING_DESCRIPTION")
			},
			{
				place = 8,
				image = "ingame_ui_sub_icons_0001",
	...
	royal_archers = {
		...
		},
		{
			...
			},
			{
				...
				place = 13,
				action = "tw_combination",
				halo = "quickmenu_action_icons_0001_hover",
				image = "tower_menu_action_icons_0001",
				tt_title = _("TOWER_ROYAL_ARCHERS_4_TOWER_COMBINATION_TITLE"),
				tt_desc = _("TOWER_ROYAL_ARCHERS_4_TOWER_COMBINATION_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_viper_goblins_lvl2",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_VIPER_GOBLINS_2_NAME"),
				tt_desc = _("TOWER_VIPER_GOBLINS_2_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_viper_goblins_lvl3",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_VIPER_GOBLINS_3_NAME"),
				tt_desc = _("TOWER_VIPER_GOBLINS_3_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_viper_goblins_lvl4",
				halo = "glow_ico_main",
				image = "main_icons_0109",
				place = 12,
				tt_title = _("TOWER_VIPER_GOBLINS_4_NAME"),
				tt_desc = _("TOWER_VIPER_GOBLINS_4_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				...
				tt_phrase = _("TOWER_VIPER_GOBLINS_4_CURSE_OF_THE_SNAKE_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_VIPER_GOBLINS_4_CURSE_OF_THE_SNAKE_1_NAME"),
						tt_desc = _("TOWER_VIPER_GOBLINS_4_CURSE_OF_THE_SNAKE_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_VIPER_GOBLINS_4_CURSE_OF_THE_SNAKE_2_NAME"),
						tt_desc = _("TOWER_VIPER_GOBLINS_4_CURSE_OF_THE_SNAKE_2_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_VIPER_GOBLINS_4_CURSE_OF_THE_SNAKE_3_NAME"),
						tt_desc = _("TOWER_VIPER_GOBLINS_4_CURSE_OF_THE_SNAKE_3_DESCRIPTION")
					}
				}
			},
			{
				check = "special_icons_0020",
				action_arg = "snake_bomb",
				action = "upgrade_power",
				...
				tt_phrase = _("TOWER_VIPER_GOBLINS_4_SNAKE_BOMB_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_VIPER_GOBLINS_4_SNAKE_BOMB_1_NAME"),
						tt_desc = _("TOWER_VIPER_GOBLINS_4_SNAKE_BOMB_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_VIPER_GOBLINS_4_SNAKE_BOMB_2_NAME"),
						tt_desc = _("TOWER_VIPER_GOBLINS_4_SNAKE_BOMB_2_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_VIPER_GOBLINS_4_SNAKE_BOMB_3_NAME"),
						tt_desc = _("TOWER_VIPER_GOBLINS_4_SNAKE_BOMB_3_DESCRIPTION")
					}
				}
			},
			{
	...
	ghost = {
		{
			...
			},
			{
				...
				halo = "glow_ico_main",
				image = "tower_icons_0124",
				place = 6,
				tt_title = _("TOWER_SPIRIT_MAUSOLEUM_2_NAME"),
				tt_desc = _("TOWER_SPIRIT_MAUSOLEUM_2_DESCRIPTION")
			},
			{
				place = 8,
				image = "ingame_ui_sub_icons_0001",
	...
	arborean_emissary = {
		{
			...
			},
			{
				...
				place = 13,
				halo = "quickmenu_action_icons_0001_hover",
				tt_title_mode1 = _("TOWER_ARBOREAN_EMISSARY_CHANGE_SOLDIERS_TITLE_1"),
				tt_desc_mode1 = _("TOWER_ARBOREAN_EMISSARY_CHANGE_SOLDIERS_DESCRIPTION_1"),
				tt_title_mode0 = _("TOWER_ARBOREAN_EMISSARY_CHANGE_SOLDIERS_TITLE_2"),
				tt_desc_mode0 = _("TOWER_ARBOREAN_EMISSARY_CHANGE_SOLDIERS_DESCRIPTION_2")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		},
		{
			...
			},
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_stage_20_arborean_honey",
				halo = "glow_ico_main",
				image = "main_icons_0037",
				place = 6,
				tt_title = _("TOWER_STAGE_20_ARBOREAN_HONEY_NAME"),
				tt_desc = _("TOWER_STAGE_20_ARBOREAN_HONEY_DESCRIPTION")
			},
			{
				check = "quickmenu_action_icons_0003",
				action = "tw_change_mode",
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_elder_portal_lvl2",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_ELDER_PORTAL_2_NAME"),
				tt_desc = _("TOWER_ELDER_PORTAL_2_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_elder_portal_lvl3",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_ELDER_PORTAL_3_NAME"),
				tt_desc = _("TOWER_ELDER_PORTAL_3_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				...
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_ELDER_PORTAL_4_NAME"),
				tt_desc = _("TOWER_ELDER_PORTAL_4_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				...
				tt_phrase = _("TOWER_ELDER_PORTAL_4_ORBITAL_CANNON_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_ELDER_PORTAL_4_ORBITAL_CANNON_1_NAME"),
						tt_desc = _("TOWER_ELDER_PORTAL_4_ORBITAL_CANNON_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_ELDER_PORTAL_4_ORBITAL_CANNON_2_NAME"),
						tt_desc = _("TOWER_ELDER_PORTAL_4_ORBITAL_CANNON_2_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_ELDER_PORTAL_4_ORBITAL_CANNON_3_NAME"),
						tt_desc = _("TOWER_ELDER_PORTAL_4_ORBITAL_CANNON_3_DESCRIPTION")
					}
				}
			},
			{
				...
				tt_phrase = _("TOWER_ELDER_PORTAL_4_TELEPORT_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_ELDER_PORTAL_4_TELEPORT_1_NAME"),
						tt_desc = _("TOWER_ELDER_PORTAL_4_TELEPORT_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_ELDER_PORTAL_4_TELEPORT_2_NAME"),
						tt_desc = _("TOWER_ELDER_PORTAL_4_TELEPORT_2_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_ELDER_PORTAL_4_TELEPORT_3_NAME"),
						tt_desc = _("TOWER_ELDER_PORTAL_4_TELEPORT_3_DESCRIPTION")
					}
				}
			},
			{
	...
	elven_stargazers = {
		{
			...
			},
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_elven_barrack_lvl2",
				halo = "glow_ico_main",
				image = "tower_icons_0107",
				place = 6,
			...
			},
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_elven_archer_2",
				halo = "glow_ico_main",
				image = "tower_icons_0128",
				place = 7,
				tt_title = _("TOWER_ELVEN_ARCHER_2_NAME"),
				tt_desc = _("TOWER_ELVEN_ARCHER_2_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
	...
	sand = {
		...
		},
		{
			...
			},
			{
				...
				halo = "glow_ico_main",
				image = "tower_icons_0102",
				place = 2,
				tt_title = _("TOWER_ASSASSINS_NAME"),
				tt_desc = _("TOWER_ASSASSINS_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_hammerhold_archer",
				halo = "glow_ico_main",
				image = "tower_icons_0126",
				place = 3,
				tt_title = _("TOWER_HAMMERHOLD_ARCHER_NAME"),
				tt_desc = _("TOWER_HAMMERHOLD_ARCHER_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
	...
	ray = {
		...
		},
		{
			...
			},
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_stage_13_sunray",
				halo = "glow_ico_main",
				image = "main_icons_0030",
				place = 7,
				tt_title = _("TOWER_STAGE_13_SUNRAY_NAME"),
				tt_desc = _("TOWER_STAGE_13_SUNRAY_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0035",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "shield",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0036",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "healing",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0037",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				action_arg = "dual",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0001",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"BarrackBarbarianDoubleAxesTaunt"
				},
				tt_phrase = _("TOWER_BARBARIANS_DOUBLE_AXE_NOTE"),
				tt_list = {
					{
			...
			},
			{
				...
				action_arg = "twister",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0002",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "throwing",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0003",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
					"BarrackBarbarianThrowingAxesTaunt"
				},
				tt_phrase = _("TOWER_BARBARIANS_THROWING_AXES_NOTE"),
				tt_list = {
					{
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0027",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "blood",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0028",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
					"TemplarTauntThree"
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0029",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				action_arg = "sneak",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0006",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"AssassinTauntSneak"
				},
				tt_phrase = _("TOWER_ASSASSINS_SNEAK_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_ASSASSINS_SNEAK_NAME_1"),
						tt_desc = _("TOWER_ASSASSINS_SNEAK_DESCRIPTION_1")
					},
					{
						tt_title = _("TOWER_ASSASSINS_SNEAK_NAME_2"),
						tt_desc = _("TOWER_ASSASSINS_SNEAK_DESCRIPTION_2")
					},
					{
						tt_title = _("TOWER_ASSASSINS_SNEAK_NAME_3"),
						tt_desc = _("TOWER_ASSASSINS_SNEAK_DESCRIPTION_3")
					}
				}
			},
			{
				...
				action_arg = "counter",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0005",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
					"AssassinTauntCounter"
				},
				tt_phrase = _("TOWER_ASSASSINS_COUNTER_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_ASSASSINS_COUNTER_NAME_1"),
						tt_desc = _("TOWER_ASSASSINS_COUNTER_DESCRIPTION_1")
					},
					{
						tt_title = _("TOWER_ASSASSINS_COUNTER_NAME_2"),
						tt_desc = _("TOWER_ASSASSINS_COUNTER_DESCRIPTION_2")
					},
					{
						tt_title = _("TOWER_ASSASSINS_COUNTER_NAME_3"),
						tt_desc = _("TOWER_ASSASSINS_COUNTER_DESCRIPTION_3")
					}
				}
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0004",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
					"AssassinTauntGold"
				},
				tt_phrase = _("TOWER_ASSASSINS_PICK_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_ASSASSINS_PICK_NAME_1"),
						tt_desc = _("TOWER_ASSASSINS_PICK_DESCRIPTION_1")
					},
					{
						tt_title = _("TOWER_ASSASSINS_PICK_NAME_2"),
						tt_desc = _("TOWER_ASSASSINS_PICK_DESCRIPTION_2")
					}
				}
			},
			{
	...
	entwood = {
		{
			{
				check = "special_icons_0020",
				action_arg = "forest_keepers",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0013",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"ElvesBarrackForestKeeperCircleOfLifeTaunt"
				},
				tt_phrase = _("TOWER_ENTWOOD_FOREST_KEEPERS_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_ENTWOOD_FOREST_KEEPERS_NAME"),
						tt_desc = _("TOWER_ENTWOOD_FOREST_KEEPERS_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_ENTWOOD_FOREST_KEEPERS_NAME"),
						tt_desc = _("TOWER_ENTWOOD_FOREST_KEEPERS_DESCRIPTION")
			...
			},
			{
				...
				action_arg = "clobber",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0008",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0007",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0009",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "frankie",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0010",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				action_arg = "bolt",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0011",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0012",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_rock_thrower_lvl2",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_rock_thrower_lvl3",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_rock_thrower_lvl4",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
		...
		{
			{
				...
				action_arg = "sylvan",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0015",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
				...
				tt_list = {
					{
						tt_title = _("TOWER_STONE_DRUID_SYLVAN_1_NAME"),
						tt_desc = _("TOWER_STONE_DRUID_SYLVAN_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_STONE_DRUID_SYLVAN_2_NAME"),
						tt_desc = _("TOWER_STONE_DRUID_SYLVAN_2_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_STONE_DRUID_SYLVAN_3_NAME"),
						tt_desc = _("TOWER_STONE_DRUID_SYLVAN_3_DESCRIPTION")
					}
				}
			},
			{
				...
				action_arg = "nature",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0014",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
					"SoldierDruidBearRallyChange"
				},
				tt_phrase = _("TOWER_STONE_DRUID_NATURE_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_STONE_DRUID_NATURE_1_NAME"),
						tt_desc = _("TOWER_STONE_DRUID_NATURE_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_STONE_DRUID_NATURE_2_NAME"),
						tt_desc = _("TOWER_STONE_DRUID_NATURE_2_DESCRIPTION")
					}
				}
			},
			{
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_elven_barrack_lvl3",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_special_elf",
				halo = "glow_ico_main",
				image = "tower_icons_0108",
				place = 1,
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0017",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0016",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "swirling",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0018",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				image = "main_icons_0015",
				place = 12,
				tt_title = _("TOWER_ELF_HOLDER_REPAIR_NAME"),
				tt_desc = _("TOWER_ELF_HOLDER_DESCRIPTION")
			}
		}
	},
	special_elf = {
		{
			{
				check = "main_icons_0019",
				action = "tw_buy_soldier",
				action_arg = "kr4_elven_warrior",
				halo = "glow_ico_main",
				image = "soldier_icons_0001",
				place = 12,
				tt_list = {
					{
						tt_title = _("SPECIAL_ELF_NAME"),
						tt_desc = _("SPECIAL_SOLDIER_KR4_ELVEN_WARRIOR_DESCRIPTION")
					},
					{
						tt_title = _("SPECIAL_ELF_NAME"),
						tt_desc = _("SPECIAL_SOLDIER_KR4_ELVEN_WARRIOR_DESCRIPTION")
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0020",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0019",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0021",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				action_arg = "backstab",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0023",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0022",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0024",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				action_arg = "eldritch",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0025",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "ward",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0026",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				action_arg = "barrel",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0034",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
					"DwarfArcherTaunt1"
				...
				tt_list = {
					{
						tt_title = _("SPECIAL_DWARF_TOWER1_UPGRADE_1_NAME_1"),
						tt_desc = _("SPECIAL_DWARF_TOWER1_UPGRADE_1_DESCRIPTION_1")
					},
					{
						tt_title = _("SPECIAL_DWARF_TOWER1_UPGRADE_1_NAME_2"),
						tt_desc = _("SPECIAL_DWARF_TOWER1_UPGRADE_1_DESCRIPTION_2")
					},
					{
						tt_title = _("SPECIAL_DWARF_TOWER1_UPGRADE_1_NAME_3"),
			...
			},
			{
				...
				action_arg = "extra_damage",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0033",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
					"DwarfArcherTaunt2"
				...
				tt_list = {
					{
						tt_title = _("SPECIAL_DWARF_TOWER1_UPGRADE_2_NAME_1"),
						tt_desc = _("SPECIAL_DWARF_TOWER1_UPGRADE_2_DESCRIPTION_1")
					},
					{
						tt_title = _("SPECIAL_DWARF_TOWER1_UPGRADE_2_NAME_2"),
						tt_desc = _("SPECIAL_DWARF_TOWER1_UPGRADE_2_DESCRIPTION_2")
					},
					{
						tt_title = _("SPECIAL_DWARF_TOWER1_UPGRADE_2_NAME_3"),
		...
		{
			{
				...
				action_arg = "armor",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0030",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"DwarfTaunt"
			...
			},
			{
				...
				action_arg = "hammer",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0031",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
					"DwarfTaunt"
			...
			},
			{
				...
				action_arg = "beer",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0032",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
					"DwarfTaunt"
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0039",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "eagle",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0040",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
					"CrossbowTauntEagle"
		...
		{
			{
				...
				action_arg = "poison",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0038",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"ArcherRangerPoisonTaunt"
				},
				tt_phrase = _("TOWER_TOTEM_POISON_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_TOTEM_POISON_NAME_1"),
						tt_desc = _("TOWER_TOTEM_POISON_DESCRIPTION_1")
					},
					{
						tt_title = _("TOWER_TOTEM_POISON_NAME_2"),
						tt_desc = _("TOWER_TOTEM_POISON_DESCRIPTION_2")
					},
					{
						tt_title = _("TOWER_TOTEM_POISON_NAME_3"),
						tt_desc = _("TOWER_TOTEM_POISON_DESCRIPTION_3")
					}
				}
			},
			{
				...
				action_arg = "weakness",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0041",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
					"TotemTauntTotemOne"
			...
			},
			{
				...
				action_arg = "silence",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0042",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
					"TotemTauntTotemTwo"
		...
		{
			{
				...
				action_arg = "sniper",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0043",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "shrapnel",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0044",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_SPIRIT_MAUSOLEUM_3_NAME"),
				tt_desc = _("TOWER_SPIRIT_MAUSOLEUM_3_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				...
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_SPIRIT_MAUSOLEUM_4_NAME"),
				tt_desc = _("TOWER_SPIRIT_MAUSOLEUM_4_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0046",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"fallen_ones_spirit_mausoleum_gargoyles_upgrade"
				},
				tt_phrase = _("TOWER_SPIRIT_MAUSOLEUM_4_GARGOYLES_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_SPIRIT_MAUSOLEUM_4_GARGOYLES_NAME_1"),
						tt_desc = _("TOWER_SPIRIT_MAUSOLEUM_4_GARGOYLES_DESCRIPTION_1")
					},
					{
						tt_title = _("TOWER_SPIRIT_MAUSOLEUM_4_GARGOYLES_NAME_2"),
						tt_desc = _("TOWER_SPIRIT_MAUSOLEUM_4_GARGOYLES_DESCRIPTION_2")
					}
				}
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0047",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
					"fallen_ones_spirit_mausoleum_communion_upgrade"
				},
				tt_phrase = _("TOWER_SPIRIT_MAUSOLEUM_4_SPECTRAL_COMMUNION_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_SPIRIT_MAUSOLEUM_4_SPECTRAL_COMMUNION_NAME_1"),
						tt_desc = _("TOWER_SPIRIT_MAUSOLEUM_4_SPECTRAL_COMMUNION_DESCRIPTION_1")
					},
					{
						tt_title = _("TOWER_SPIRIT_MAUSOLEUM_4_SPECTRAL_COMMUNION_NAME_2"),
						tt_desc = _("TOWER_SPIRIT_MAUSOLEUM_4_SPECTRAL_COMMUNION_DESCRIPTION_2")
					}
				}
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0045",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
					"fallen_ones_spirit_mausoleum_possesion_upgrade"
				},
				tt_phrase = _("TOWER_SPIRIT_MAUSOLEUM_4_POSSESSION_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_SPIRIT_MAUSOLEUM_4_POSSESSION_NAME_1"),
						tt_desc = _("TOWER_SPIRIT_MAUSOLEUM_4_POSSESSION_DESCRIPTION_1")
					},
					{
						tt_title = _("TOWER_SPIRIT_MAUSOLEUM_4_POSSESSION_NAME_2"),
						tt_desc = _("TOWER_SPIRIT_MAUSOLEUM_4_POSSESSION_DESCRIPTION_2")
					},
					{
						tt_title = _("TOWER_SPIRIT_MAUSOLEUM_4_POSSESSION_NAME_3"),
						tt_desc = _("TOWER_SPIRIT_MAUSOLEUM_4_POSSESSION_DESCRIPTION_3")
					}
				}
			},
			{
	...
	warmongers_barrack = {
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_warmongers_barrack_lvl2",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_WARMONGERS_BARRACK_LVL2_NAME"),
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_warmongers_barrack_lvl3",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_WARMONGERS_BARRACK_LVL3_NAME"),
				tt_desc = _("TOWER_WARMONGERS_BARRACK_LVL3_DESCRIPTION")
			},
			{
				place = 8,
				image = "ingame_ui_sub_icons_0001",
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_warmongers_barrack_lvl4",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_WARMONGERS_BARRACK_LVL4_NAME"),
				tt_desc = _("TOWER_WARMONGERS_BARRACK_LVL4_DESCRIPTION")
			},
			{
				place = 8,
				image = "ingame_ui_sub_icons_0001",
		...
		},
		{
			{
				check = "special_icons_0020",
				action_arg = "battlewits",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0048",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"warmonger_barrack_extra_armor_upgrade"
				},
				tt_phrase = _("TOWER_WARMONGERS_BARRACK_LVL4_BATTLEWITS_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_WARMONGERS_BARRACK_LVL4_BATTLEWITS_1_NAME"),
						tt_desc = _("TOWER_WARMONGERS_BARRACK_LVL4_BATTLEWITS_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_WARMONGERS_BARRACK_LVL4_BATTLEWITS_2_NAME"),
						tt_desc = _("TOWER_WARMONGERS_BARRACK_LVL4_BATTLEWITS_2_DESCRIPTION")
					}
				}
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0049",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
					"warmonger_barrack_unit_swap_upgrade"
				},
				tt_phrase = _("TOWER_WARMONGERS_BARRACK_LVL4_PROMOTION_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_WARMONGERS_BARRACK_LVL4_PROMOTION_1_NAME"),
						tt_desc = _("TOWER_WARMONGERS_BARRACK_LVL4_PROMOTION_1_DESCRIPTION")
					}
				}
			},
			{
				check = "special_icons_0020",
				action_arg = "seal_of_blood",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0050",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
					"warmonger_barrack_regeneration_upgrade"
				},
				tt_phrase = _("TOWER_WARMONGERS_BARRACK_LVL4_SEAL_OF_BLOOD_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_WARMONGERS_BARRACK_LVL4_SEAL_OF_BLOOD_1_NAME"),
						tt_desc = _("TOWER_WARMONGERS_BARRACK_LVL4_SEAL_OF_BLOOD_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_WARMONGERS_BARRACK_LVL4_SEAL_OF_BLOOD_2_NAME"),
						tt_desc = _("TOWER_WARMONGERS_BARRACK_LVL4_SEAL_OF_BLOOD_2_DESCRIPTION")
					}
				}
			},
			{
		...
		{
			{
				...
				action_arg = "formation",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0051",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
					"legionnaire_taunt_2"
				},
				tt_phrase = _("TOWER_HAMMERHOLD_ARCHER_FORMATION_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_HAMMERHOLD_ARCHER_FORMATION_1_NAME"),
						tt_desc = _("TOWER_HAMMERHOLD_ARCHER_FORMATION_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_HAMMERHOLD_ARCHER_FORMATION_2_NAME"),
						tt_desc = _("TOWER_HAMMERHOLD_ARCHER_FORMATION_2_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_HAMMERHOLD_ARCHER_FORMATION_3_NAME"),
						tt_desc = _("TOWER_HAMMERHOLD_ARCHER_FORMATION_3_DESCRIPTION")
					}
				}
			},
			{
				check = "special_icons_0020",
				action_arg = "war_elephants",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0052",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
					"kr4_enemies_sandstorm_elephant_ambient_1"
				},
				tt_phrase = _("TOWER_HAMMERHOLD_ARCHER_WAR_ELEPHANTS_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_HAMMERHOLD_ARCHER_WAR_ELEPHANTS_1_NAME"),
						tt_desc = _("TOWER_HAMMERHOLD_ARCHER_WAR_ELEPHANTS_1_DESCRIPTION")
					}
				}
			},
			{
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0053",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
					"PirateTowerTaunt1"
			...
			},
			{
				...
				action_arg = "parrot",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0054",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
					"PirateTowerTaunt2"
	...
	mercenaries_amazonas = {
		{
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0055",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"SpecialCarnivorePlant"
				},
				tt_phrase = _("TOWER_BARRACK_AMAZONAS_CARNIVOROUS_PLANT_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_BARRACK_AMAZONAS_CARNIVOROUS_PLANT_1_NAME"),
						tt_desc = _("TOWER_BARRACK_AMAZONAS_CARNIVOROUS_PLANT_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_BARRACK_AMAZONAS_CARNIVOROUS_PLANT_2_NAME"),
						tt_desc = _("TOWER_BARRACK_AMAZONAS_CARNIVOROUS_PLANT_2_DESCRIPTION")
					}
				}
			},
			{
	...
	ewok = {
		{
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0061",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"ElvesPlantReady"
		...
		{
			{
				...
				action_arg = "cream",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0056",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
					"ElvesGnomeNew"
			...
			},
			{
				...
				action_arg = "total",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0057",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
					"ElvesGnomePower"
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0060",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"VenomPlantReady"
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0058",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0059",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_elven_archer_3",
				halo = "glow_ico_main",
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_ELVEN_ARCHER_3_NAME"),
				tt_desc = _("TOWER_ELVEN_ARCHER_3_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
				action_arg = "tower_arcane_archer",
				halo = "glow_ico_main",
				image = "tower_icons_0129",
				place = 6,
		...
		{
			{
				...
				action_arg = "burst",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0062",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "slumber",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0063",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				action_arg = "sentence",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0064",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
					"ElvesArcherGoldenBowCrimsonTaunt"
			...
			},
			{
				...
				action_arg = "mark",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0065",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
					"ElvesArcherGoldenBowMarkTaunt"
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0066",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "sentinel",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0067",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_IGNIS_ALTAR_LVL2_NAME"),
				tt_desc = _("TOWER_IGNIS_ALTAR_LVL2_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				...
				image = "main_icons_0005",
				place = 12,
				tt_title = _("TOWER_IGNIS_ALTAR_LVL3_NAME"),
				tt_desc = _("TOWER_IGNIS_ALTAR_LVL3_DESCRIPTION")
			},
			{
				check = "ingame_ui_ico_sell_0002",
				action = "tw_sell",
		...
		{
			{
				...
				image = "tower_icons_0132",
				place = 1,
				tt_title = _("TOWER_IGNIS_ALTAR_LVL4_NAME"),
				tt_desc = _("TOWER_IGNIS_ALTAR_LVL4_DESCRIPTION")
			},
			{
				check = "main_icons_0019",
				action = "tw_upgrade",
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0068",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"ignis_altar_upgrade_elemental"
				},
				tt_phrase = _("TOWER_IGNIS_ALTAR_LVL4_BURNING_ELEMENTAL_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_IGNIS_ALTAR_LVL4_BURNING_ELEMENTAL_1_NAME"),
						tt_desc = _("TOWER_IGNIS_ALTAR_LVL4_BURNING_ELEMENTAL_1_DESCRIPTION")
					}
				}
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0069",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
					"ignis_altar_upgrade_debuff"
				},
				tt_phrase = _("TOWER_IGNIS_ALTAR_LVL4_SINGLE_EXTINCTION_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_IGNIS_ALTAR_LVL4_SINGLE_EXTINCTION_1_NAME"),
						tt_desc = _("TOWER_IGNIS_ALTAR_LVL4_SINGLE_EXTINCTION_1_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_IGNIS_ALTAR_LVL4_SINGLE_EXTINCTION_2_NAME"),
						tt_desc = _("TOWER_IGNIS_ALTAR_LVL4_SINGLE_EXTINCTION_2_DESCRIPTION")
					},
					{
						tt_title = _("TOWER_IGNIS_ALTAR_LVL4_SINGLE_EXTINCTION_3_NAME"),
						tt_desc = _("TOWER_IGNIS_ALTAR_LVL4_SINGLE_EXTINCTION_3_DESCRIPTION")
					}
				}
			},
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0070",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
					"ignis_altar_upgrade_true_fire"
				},
				tt_phrase = _("TOWER_IGNIS_ALTAR_LVL4_TRUE_FIRE_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_IGNIS_ALTAR_LVL4_TRUE_FIRE_1_NAME"),
						tt_desc = _("TOWER_IGNIS_ALTAR_LVL4_TRUE_FIRE_1_DESCRIPTION")
					}
				}
			},
			{
		...
		{
			{
				...
				action_arg = "missile",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0083",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "cluster",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0071",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				action_arg = "drill",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0072",
				place = 1,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "lava",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0073",
				place = 2,
				halo = "glow_ico_special",
				sounds = {
			...
			{
				check = "special_icons_0020",
				action_arg = "batteries",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0074",
				place = 3,
				halo = "glow_ico_special",
				sounds = {
					"EarthquakeTauntReady"
				},
				tt_phrase = _("TOWER_DWAARP_BATTERIES_NOTE"),
				tt_list = {
					{
						tt_title = _("TOWER_DWAARP_BATTERIES_NAME_1"),
						tt_desc = _("TOWER_DWAARP_BATTERIES_DESCRIPTION_1")
					}
				}
			},
			{
		...
		{
			{
				...
				action_arg = "missile",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0075",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
					"MechTauntMissile"
			...
			},
			{
				...
				action_arg = "oil",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0076",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
					"MechTauntSlow"
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0077",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
					"Sheep"
			...
			},
			{
				...
				image = "tower_upgrade_icons_0078",
				place = 7,
		...
		{
			{
				...
				action_arg = "twister",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0079",
				place = 6,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				action_arg = "blast",
				action = "upgrade_power",
				image = "tower_upgrade_icons_0080",
				place = 7,
				halo = "glow_ico_special",
				sounds = {
		...
		{
			{
				...
				image = "tower_upgrade_icons_0081",
				use_tw_upgrade_halo = true,
				place = 12,
				action_arg = "ray",
				sounds = {
		...
		{
			{
				...
				action = "upgrade_power",
				image = "tower_upgrade_icons_0082",
				place = 12,
				halo = "glow_ico_special",
				sounds = {
			...
			},
			{
				...
				image = "quickmenu_action_icons_0004",
				place = 13,
				tt_title_mode1 = _("ELVES_TOWER_BASTION_FLIP_TITLE"),
