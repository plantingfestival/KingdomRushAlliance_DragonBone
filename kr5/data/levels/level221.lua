...
function level:load(store)
	LU.insert_background(store, "Stage221_0001", Z_BACKGROUND)
	LU.insert_background(store, "Stage221_0002", Z_OBJECTS, 666)
	LU.insert_background(store, "Stage221_0003", Z_OBJECTS, 595)
	LU.insert_background(store, "Stage221_0004", Z_OBJECTS, 540)
	LU.insert_background(store, "Stage221_0005", Z_OBJECTS, 558)
	LU.insert_background(store, "Stage221_0006", Z_OBJECTS, 525)
	LU.insert_background(store, "Stage221_0007", Z_OBJECTS_COVERS)
	...
	for _, h in pairs(self.locations.holders) do
		if store.level_mode == GAME_MODE_IRON and table.contains({
			...
			LU.insert_tower(store, "tower_paladin_covenant_lvl2", h.style, h.pos, h.rally_pos, 0, h.id)
		else
