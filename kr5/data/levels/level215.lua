...
level.show_comic_idx = 4
level.pan_extension = (KR_TARGET == "phone" or KR_TARGET == "tablet") and {
	top = 48
} or nil
...
function level:load(store)
	local bg_prefix = (KR_TARGET == "phone" or KR_TARGET == "tablet") and "stage215_tall_" or "stage215_"
	local bg_offset = (KR_TARGET == "phone" or KR_TARGET == "tablet") and 24 or 0
