-- chunkname: @C:\\Users\\dev02\\Desktop\\Customized KR5\\Kingdom Rush Alliance\\kr5\\data\\levels\\level126_data.lua
...
return {
	...
	entities_list = {
		...
		{
			["render.sprites[1].name"] = "stage_126_0002",
			template = "decal_background",
			["render.sprites[1].z"] = 3000,
		...
		{
			["render.sprites[1].name"] = "stage_126",
			template = "decal_background",
		...
		{
			["render.sprites[1].name"] = "stage_126_0003",
			template = "decal_background",
			["render.sprites[1].z"] = 3000,
