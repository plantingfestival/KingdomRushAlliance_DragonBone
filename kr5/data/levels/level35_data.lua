return {
	...
	required_exoskeletons = {
		"random_stage31_wood_holder_cuernosDef",
		"random_stage31_wood_holder_dragon_rootDef",
		"random_stage31_wood_holder_dragonDef",
		"random_stage31_wood_holder_gradienteDef",
		"random_stage31_wood_holder_habilidad_1Def",
		"random_stage31_wood_holder_jarraDef",
		"random_stage31_wood_holder_jarrahojasDef",
		"random_stage31_wood_holder_rayo_explosionDef",
		"random_stage31_wood_holder_rayoDef",
		"random_stage31_wood_holder_root1Def",
		"random_stage31_wood_holder_root2Def",
		"random_stage31_wood_holder_root3Def",
		"random_stage31_wood_holder_root4Def",
		"random_stage31_wood_holder_animations_parcheDef",
		"random_fireholder_cuernosDef",
		"random_fireholder_dragonDef",
		"random_fireholder_dragon_executionDef",
		"random_fireholder_dragon_rootDef",
		"random_fireholder_gradienteDef",
		"random_fireholder_habilidad_1Def",
		"random_fireholder_jarraDef",
		"random_fireholder_jarrahojasDef",
		"random_fireholder_rayoDef",
		"random_fireholder_rayo_explosionDef",
		"random_fireholder_dragon_executionDef",
		"random_dirtholder_cuernosDef",
		"random_dirtholder_dragonDef",
		"random_dirtholder_gradienteDef",
		"random_dirtholder_habilidad_1Def",
		"random_dirtholder_jarraDef",
		"random_dirtholder_jarrahojasDef",
		"random_dirtholder_parcheDef",
		"random_dirtholder_rayo_explosionDef",
		"random_dirtholder_rayoDef",
		"random_stage33_water_mistDef",
		"random_stage33_water_holder_animations_parcheDef",
		"random_stage33_water_holder_cuernosDef",
		"random_stage33_water_holder_dragonDef",
		"random_stage33_water_holder_gradienteDef",
		"random_stage33_water_holder_habilidad_1Def",
		"random_stage33_water_holder_healDef",
		"random_stage33_water_holder_jarraDef",
		"random_stage33_water_holder_jarrahojasDef",
		"random_stage33_water_holder_rayo_explosionDef",
		"random_stage33_water_holder_rayoDef",
		"random_stage33_water_dragonflyDef",
		"random_stage33_water_dragonrootDef",
		...
		"random_goldholder_coin_splashDef",
		"random_goldholder_cuernosDef",
		"random_goldholder_dragon_rootDef",
		"random_goldholder_dragonDef",
		"random_goldholder_gradienteDef",
		"random_goldholder_habilidad_1Def",
		"random_goldholder_jarraDef",
		"random_goldholder_jarrahojasDef",
		"random_goldholder_rayo_explosionDef",
		"random_goldholder_rayoDef",
