...
local log = require("klua.log"):new("level217")
...
function level:load(store)
	LU.insert_background(store, "stage217_0001", Z_BACKGROUND)
	...
	for _, p in pairs(fish_pos) do
		e = E:create_entity("decal_jumping_fish")
		e.pos = p
...
function level:update(store)
	LU.queue_insert(store, "hero_steam_frigate", V.v(646, 421))
