local a = {
	-- customization
	hero_wukong_dragon_ultimate_dragon_blue = {
		prefix = "hero_wukong_dragon_ultimate_dragon_blue",
		to = 70,
		from = 1
	},
	hero_wukong_dragon_ultimate_dragon_red = {
		prefix = "hero_wukong_dragon_ultimate_dragon_red",
		to = 70,
		from = 1
	},
	hero_wukong_dragon_ultimate_dragon_yellow = {
		prefix = "hero_wukong_dragon_ultimate_dragon_yellow",
		to = 70,
		from = 1
	},
	-- customization
