...
return {
	...
	children = {
		...
		},
		{
			frame_duration = 55,
			class = "GGTimeline",
			id = "flag_unlock_anim_dlc_2",
			fps = 30,
			pos = v(1326.45, 1337.2),
			scale = v(1, 1),
			children = {
				{
					id = "l0_animation_flag_dlc_2_unlock",
					class = "GGAni",
					pos = v(-1.95, -39.8),
					anchor = v(159.85, 158.5),
					animation = {
						to = 55,
						prefix = "map_dlc_special_flag_animation_flag_dlc_2_unlock",
						from = 1
					}
				}
			},
		...
		},
		{
			...
			children = {
				...
				{
					focus_image_name = "map_dlc_special_flag_button_wukong_flag_0003",
					class = "GG5Button",
					default_image_name = "map_dlc_special_flag_button_wukong_flag_0001",
					pos = v(-7.4, -33.4),
					anchor = v(41.55, 60.75)
				}
			}
		}
	}
