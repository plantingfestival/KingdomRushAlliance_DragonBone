-- chunkname: @./kr5/data/kui_templates/group_options_page_general_e2w.lua
...
return {
	...
	children = {
		...
		},
		{
			...
			fit_size = true,
			text = "Redeem Code",
			text_key = "REDEEM_CODE",
			class = "GG5ShaderLabel",
			id = "label_redeem_code",
			font_name = "fla_body",
			pos = v(735.35, 310.75),
			scale = v(1, 1),
			size = v(150, 87.3),
		...
		{
			id = "button_redeem_code",
			focus_image_name = "gui_popups_button_redeem_code_0003",
			class = "GG5Button",
			default_image_name = "gui_popups_button_redeem_code_0001",
			pos = v(810.85, 255.55),
			anchor = v(56.15, 55.95)
		}
	}
