-- chunkname: @./sequels/screen_slots.lua
...
function SlotView.show(arg_92_0)
	...
	if not var_92_1 then
		...
		local var_92_2, var_92_3, var_92_4 = var_0_5:get_slot_stats(var_92_1)
		local var_92_5 = var_92_2 + (var_92_3 + var_92_4) * (var_0_12.stars_per_mode == 0 and -1 or 0)

		var_92_0("label_stars").text = tostring(var_92_5) .. "/" .. tostring(var_0_12.max_stars)
		var_92_0("label_heroic").text = tostring(var_92_3)
		var_92_0("label_iron").text = tostring(var_92_4)
	end
end
