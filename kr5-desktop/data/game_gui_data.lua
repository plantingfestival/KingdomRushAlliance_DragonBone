...
return {
	...
	tower_menu_button_places = {
		...
		[21] = v(-80 * ring_scale, -150 * ring_scale),
		[22] = v(80 * ring_scale, -150 * ring_scale),
		[23] = v(-155 * ring_scale, 0 * ring_scale),
		[24] = v(155 * ring_scale, 0 * ring_scale),
		[25] = v(-80 * ring_scale, 150 * ring_scale),
		[26] = v(80 * ring_scale, 150 * ring_scale),
	},
