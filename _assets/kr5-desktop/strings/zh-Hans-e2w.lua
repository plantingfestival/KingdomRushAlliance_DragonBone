-- chunkname: @./_assets/kr5-desktop/strings/zh-Hans-e2w.lua

return {
	LEVEL_SELECT_CHALLENGE_ONE_LIFE = "共1点生命",
	["Produced by %s"] = "%s 出品",
	ENEMY_UNBLINDED_ABOMINATION_SPECIAL = "偶尔会带走低血量单位。",
	ACHIEVEMENT_A_COON_OF_SURPRISES_DESCRIPTION = "帮助弗雷多逃脱。",
	...
	SPECIAL_SOLDIER_TOWER_ELVEN_BARRACK_2_NAME = "精灵雇佣兵 2",
	SPECIAL_SOLDIER_TOWER_ELVEN_BARRACK_1_NAME = "精灵雇佣兵 1",
	SPECIAL_SOLDIER_TOWER_ELVEN_BARRACK_1_DESCRIPTION = "招募1名精灵雇佣军并肩作战。战败后过10秒可重生。",
	POPUP_LABEL_MAIN_MENU = "主菜单",
	LEVEL_28_TITLE = "28. 亵渎的寺庙",
	TOWER_ROYAL_ARCHERS_DESC = "王国中最强大的神射手，他们还因与战鹰并肩作战而闻名遐迩。",
	HERO_BIRD_EAT_INSTAKILL_DESCRIPTION_3 = "狮鹫俯冲地面，带走一名生命值不超过%$heroes.hero_bird.eat_instakill.hp_max[3]%$的敌人。",
	...
	SPECIAL_REPAIR_HOLDER_SPIDERS_DESCRIPTION = "解救被蛛网困住的持有者，以启用这个战略点。",
	...
	ENEMY_ACOLYTE_TENTACLE_EXTRA = "- 仆从倒地时产生。",
	...
	TOWER_ARCANE_WIZARD_DESC = "利尼维亚的法师能够运用纯粹的魔法，彻底击败他们的敌人。",
	...
	ENEMY_SPIDER_PRIEST_DESCRIPTION = "被新神束缚，这些祭司踏上战场，施展黑暗魔法。",
	...
	LEVEL_4_HISTORY = "目前森林之心已经安全了，我们必须重新集结，乘胜追击。是时候将战线推向野兽族的领地了。带领部队登上森林的树梢，可以从制高点寻找它们的营地。",
	...
	TAUNT_STAGE15_CULTIST_BEFORE_BOSSFIGHT_0001 = "愚蠢的笨蛋！你这是徒劳。",
	...
	ENEMY_UNBLINDED_SHACKLER_DESCRIPTION = "锁链者通过嵌入手臂的水晶来引导腐化魔法，在近身战斗中是令人生畏的对手。",
	SOLDIER_HERO_BUILDER_WORKER_4_NAME = "比尔柯",
	ENEMY_BEAR_VANGUARD_SPECIAL = "附近有熊先锋失败时会进入狂暴状态。",
	ENEMY_AMALGAM_NAME = "血壤巨兽",
	SOLDIER_HERO_BUILDER_WORKER_2_NAME = "奥图尔",
	SOLDIER_HERO_BUILDER_WORKER_1_NAME = "赫马尔",
	ABOMINATED_SOLDIER_PRIESTS_BARRACK_5_NAME = "埃多米内申",
	SOLDIER_ARBOREAN_SENTINELS_8_NAME = "乌兹基",
	ACHIEVEMENT_FIELD_TRIP_RUINER_NAME = "野炊破坏者",
	SOLDIER_ARBOREAN_SENTINELS_6_NAME = "古尔德",
	ENEMY_BALLOONING_SPIDER_DESCRIPTION = "快速而狡猾的蜘蛛，擅长避开麻烦。",
	JOYSTICK_HELP_MAP_NX_R = "下一级/页",
	SOLDIER_ARBOREAN_SENTINELS_3_NAME = "伊康",
	HERO_SPIDER_ARACNID_SPAWNER_MENUBOTTOM_DESCRIPTION = "召唤一群震慑蜘蛛。",
	LEVEL_9_IRON = "铁拳模式9",
	SOLDIER_ARBOREAN_SENTINELS_1_NAME = "巴鲁",
	LEVEL_5_TITLE = "5.荒废郊区",
	HERO_SPIDER_TUNNELING_DESCRIPTION_2 = "斯派迪尔的挖掘现在在重新浮出时造成 %$heroes.hero_spider.tunneling.damage_min[2]%$-%$heroes.hero_spider.tunneling.damage_max[2]%$ 伤害。",
	...
	TOWER_FLAMESPITTER_1_NAME = "矮人喷火器1",
	...
	ENEMY_SMALL_STALKER_DESCRIPTION = "被教团魔法腐化的云鹰会在战场上四处穿梭，散播混乱。",
	...
	ACHIEVEMENT_A_COON_OF_SURPRISES_NAME = "充满惊喜的茧",
	MAP_BALLON_HERO_LEVELUP_DESCRIPTION = "用获得的英雄点数来训练英雄！",
	SOLDIER_RANDOM_1_NAME = "道格拉斯",
	ACHIEVEMENT_ARACHNED_DESCRIPTION = "击败蜘蛛女王米加尔。",
	...
	HERO_VENOM_RANGED_TENTACLE_DESCRIPTION_2 = "远程攻击一名敌人，造成%$heroes.hero_venom.ranged_tentacle.s_damage[2]%$点物理伤害，并有%$heroes.hero_venom.ranged_tentacle.bleed_chance[2]%$%概率施加持续伤害。每秒造成%$heroes.hero_venom.ranged_tentacle.s_bleed_damage%$点伤害，持续%$heroes.hero_venom.ranged_tentacle.bleed_duration[2]%$秒。",
	["HERO LEVEL UP!"] = "英雄升级！",
	...
	HERO_HUNTER_DESC = "安雅是知名猎人的后代，她循着父亲的足迹，勇敢对抗黑暗中的生物。对教团不懈的追猎促使她来到了南方大地，并加入到联盟当中。",
	LEVEL_7_IRON = "铁拳模式7",
	...
	HERO_VENOM_EAT_ENEMY_DESCRIPTION_1 = "格里姆森带走一个生命值低于 %$heroes.hero_venom.eat_enemy.hp_trigger%$% 的敌人，同时恢复自身总生命值的 %$heroes.hero_venom.eat_enemy.regen[1]%$%。",
	LEVEL_30_TITLE = "30. 被遗忘的王座",
	ENEMY_HARDENED_HORROR_DESCRIPTION = "这种可怕的怪物手中长有利刃，能披荆斩棘，清理出一条通路。",
	ENEMY_DREADEYE_VIPER_DESCRIPTION = "用自身毒液涂抹箭矢，并从远处精准命中。",
	...
	ENEMY_GLARENWARDEN_NAME = "炫目守卫",
	LEVEL_4_IRON = "铁拳模式4",
	ENEMY_MINDLESS_HUSK_EXTRA = "- 倒下时召唤眼精。",
	TAUNT_STAGE15_CULTIST_0002 = "新时代即将到来，你们将前功尽弃！",
	LEVEL_1_HEROIC = "英雄模式1",
	TAUNT_STAGE11_CULTIST_LEADER_IN_BOSSFIGHT_0002 = "真是大开眼界啊！",
	LEVEL_19_HISTORY = "艾利丹已经战至精疲力竭，他指引我们前往堕落神庙，一位号称灵能掌控者·汎里埃的法师唤醒了大军，企图指挥他们荡平大陆。我们必须不惜一切代价阻止他！",
	LEVEL_18_TITLE = "18. 深叶哨所",
	HERO_BUILDER_CLASS = "城防总管",
	["ARMORED ENEMIES!"] = "装甲敌人！",
	TUTORIAL_upgrade_room_tooltip_souls_desc = "完成战役关卡获得升级点数。",
	...
	SPECIAL_STAGE_11_VEZNAN_ABILITY_NAME_1 = "能量冲击",
	...
	TOWER_PALADIN_COVENANT_DESC = "骑士是利尼维亚精锐部队的中坚力量，他们能在战斗中运用神圣的力量保护和治疗自己。",
	...
	HERO_ROBOT_UPPERCUT_DESCRIPTION_2 = "击败一名生命值低于%$heroes.hero_robot.uppercut.s_life_threshold[2]%$%的敌人，一拳分胜负。",
	CReload3 = "快",
	JOYSTICK_HELP_INGAME_POWERS = "能力",
	TOWER_SAND_4_SKILL_GOLD_1_DESCRIPTION = "投掷一枚弹射镖刃，对敌人造成%$towers.sand.skill_gold.s_damage[1]%$点物理伤害，被镖刃击败的敌人会额外产生%$towers.sand.skill_gold.gold_extra[1]%$枚金币。",
	...
	HERO_VENOM_RANGED_TENTACLE_DESCRIPTION_1 = "远程攻击一名敌人，造成%$heroes.hero_venom.ranged_tentacle.s_damage[1]%$点物理伤害，并有%$heroes.hero_venom.ranged_tentacle.bleed_chance[1]%$%概率施加持续伤害。每秒造成%$heroes.hero_venom.ranged_tentacle.s_bleed_damage%$点伤害，持续%$heroes.hero_venom.ranged_tentacle.bleed_duration[1]%$秒。",
	ENEMY_BALLOONING_SPIDER_EXTRA = "- 被逼入绝境时开始飞行\n- 中等护甲",
	...
	ITEM_DEATHS_TOUCH_DESC = "在您的指尖灌注破坏之力，点击任意敌人即可瞬间消灭它们。对首领或精英怪无效。",
	...
	ACHIEVEMENT_NATURES_WRATH_DESCRIPTION = "使用森林之心击败30名敌人。",
	...
	BUTTON_NO = "否",
	ACHIEVEMENT_ONE_SHOT_TOWER_DESCRIPTION = "仅用一道暗光高塔光束就击败10个敌人。",
	HERO_VESPER_ARROW_TO_THE_KNEE_DESCRIPTION_3 = "射出一支利箭，眩晕敌人%$heroes.hero_vesper.arrow_to_the_knee.stun_duration[3]%$秒，同时造成%$heroes.hero_vesper.arrow_to_the_knee.s_damage[3]%$点物理伤害。",
	...
	HERO_VENOM_EAT_ENEMY_TITLE = "重塑生命",
	HERO_VENOM_EAT_ENEMY_DESCRIPTION_2 = "格里姆森带走一个生命值低于 %$heroes.hero_venom.eat_enemy.hp_trigger%$% 的敌人，同时恢复自身总生命值的 %$heroes.hero_venom.eat_enemy.regen[2]%$%。",
	...
	ENEMY_LESSER_SISTER_DESCRIPTION = "扭曲姐妹施展她们的危险魔法，将梦魇带入现实世界。",
	HERO_SPIDER_ARACNID_SPAWNER_DESCRIPTION_1 = "召唤 %$heroes.hero_spider.ultimate.spawn_amount[2]%$ 只蜘蛛，为 %$heroes.hero_spider.ultimate.spider.duration[2]%$ 秒而战，命中时使敌人昏迷。",
	...
	HERO_ROBOT_UPPERCUT_DESCRIPTION_1 = "击败一名生命值低于%$heroes.hero_robot.uppercut.s_life_threshold[1]%$%的敌人，一拳分胜负。",
	...
	HERO_MECHA_MINE_DROP_DESCRIPTION_3 = "英雄静止时，机甲会定期在路径上安放至多%$heroes.hero_mecha.mine_drop.max_mines[3]%$枚爆炸地雷。每枚地雷的爆炸会造成%$heroes.hero_mecha.mine_drop.damage_min[3]%$-%$heroes.hero_mecha.mine_drop.damage_max[3]%$点爆炸伤害。",
	...
	ENEMY_AMALGAM_EXTRA = "- 精英怪。\n- 失败时自爆。",
	ABOMINATED_SOLDIER_PRIESTS_BARRACK_4_NAME = "便秘的尼古拉斯",
	...
	HERO_SPIDER_ARACNID_SPAWNER_MENUBOTTOM_NAME = "猎人的召唤",
	...
	ENEMY_BOSS_PIG_NAME = "野兽之王碎辗",
	SOLDIER_TOWER_DARK_ELF_2_NAME = "菲尔瑞",
	ENEMY_SPIDEAD_DESCRIPTION = "作为蜘蛛女王Mygale的直系后裔，这些蜘蛛即使在死后也能制造麻烦。",
	...
	LEVEL_14_HISTORY = "这些讨厌的生物不知是从哪冒出来的！大部队已经身心俱疲，我们触碰到的一切都仿佛有生命，随时准备向我们发动攻击，似乎这整片土地都在尽全力与我们为敌。泛视先知魔蒂娅丝及其爪牙必定就在附近。",
	HERO_SPACE_ELF_COSMIC_PRISON_MENUBOTTOM_NAME = "异域囚笼",
	ENEMY_LESSER_EYE_DESCRIPTION = "漂浮在战场上空的狡诈之眼，作为眼巢的侦察兵而活动。",
	...
	CRange4 = "极远",
	COMIC_6_4_KR5_KR5 = "嘿！",
	ACHIEVEMENT_SPECTRAL_FURY_NAME = "无尽之怒",
	...
	Casual = "休闲",
	ENEMY_VILE_SPAWNER_DESCRIPTION = "眼巢将漫天魔眼投向敌人，无时无刻都向四面八方监视着敌人。",
	...
	LEVEL_16_HISTORY = "魔蒂娅丝已不复存在，但更强大的敌人全视之魔眼还在等着我们。这是彻底终结教团与侵略的最后机会。如果我们不能团结到最后一刻，接下来不管事态如何发展都将毫无意义。开始决战吧！",
	...
	High = "高",
	HERO_VENOM_CREEPING_DEATH_MENUBOTTOM_NAME = "生命蔓延",
	...
	ACHIEVEMENT_LUCAS_SPIDER_DESCRIPTION = "陪卢卡斯玩耍，直到他开心。",
	MAP_BALLON_HERO_LEVELUP_TITLE = "英雄升级！",
	towers_wise_investment_DESCRIPTION = "现在出售塔时，返还其建造成本的90%。",
	...
	ACHIEVEMENT_WE_RE_NOT_GONNA_TAKE_IT_DESCRIPTION = "在梦魇生成前击败15个扭曲姐妹。",
	...
	ACHIEVEMENT_PORKS_OFF_THE_MENU_NAME = "猪肉大餐",
	...
	ENEMY_DRAINBROOD_DESCRIPTION = "一只拥有致命咬击的古老蜘蛛。有些人推测它是导致其他蜘蛛结晶化的罪魁祸首。",
	...
	TOWER_SPARKING_GEODE_DESC = "源自一个古老而和平的种族，这个强大的存在遵循其保护本能，运用雷电之力为联盟而战，以风暴般的愤怒打击敌人。",
	LEVEL_13_HEROIC = "英雄模式13",
	TAUNT_LVL30_BOSS_INTRO_02 = "我要复仇，并成为这个世界的新女神...",
	...
	HERO_MECHA_DEATH_FROM_ABOVE_TITLE = "从天而降",
	ABOMINATED_SOLDIER_PRIESTS_BARRACK_8_NAME = "被玷污的赛德里克",
	...
	SPECIAL_PRIESTS_SOLDIERS_DESCRIPTION = "无眼者的信徒。",
	...
	ENEMY_ANIMATED_ARMOR_EXTRA = "- 击败后可以再次被诡秘生物附身。",
	...
	TOWER_DEMON_PIT_4_MASTER_EXPLODERS_NOTE = "只有笨蛋才会干这活儿。",
	...
	ACHIEVEMENT_SAVIOUR_OF_THE_GREEN_DESCRIPTION = "在永辉森林的每个关卡中都获得了三颗星。",
	LV22_MAGE_BEFORE_FIGHT_RESPONSE_06 = "我将保护这片森林！",
	ENEMY_SPECTER_NAME = "诡秘生物",
	...
	HERO_VESPER_ARROW_TO_THE_KNEE_DESCRIPTION_1 = "射出一支利箭，眩晕敌人%$heroes.hero_vesper.arrow_to_the_knee.stun_duration[1]%$秒，同时造成%$heroes.hero_vesper.arrow_to_the_knee.s_damage[1]%$点物理伤害。",
	...
	TAUNT_STAGE11_CULTIST_LEADER_FIGHT_0005 = "我很危险吗？当然了！",
	...
	ENEMY_GLARENWARDEN_DESCRIPTION = "这些可憎的蜘蛛是炫目族融合的产物，使它们比以往更强大、更坚韧。",
	ACHIEVEMENT_SEASONED_GENERAL_NAME = "常胜将军",
	COMIC_3_2_KR5 = "艾纳尼圣剑！",
	POPUP_SETTINGS_LANGUAGE = "语言",
	HERO_MECHA_CLASS = "巨械危机",
	ENEMY_REVENANT_SOULCALLER_NAME = "沉眠唤魂者",
	SFX = "音效",
	CRange0 = "短",
	ACHIEVEMENT_WE_ARE_ALL_MAD_HERE_DESCRIPTION = "在不灭狂怒的每一个关卡内都找到神秘猫。",
	...
	ENEMY_ACOLYTE_NAME = "教团仆从",
	ENEMY_ACOLYTE_SPECIAL = "倒地后化身为触手。",
	...
	ENEMY_UNBLINDED_ABOMINATION_EXTRA = "－带走低血量单位。",
	...
	LEVEL_6_HISTORY = "我们或许在对抗野兽族时占了上风，但仍需面对它们的领袖——碎辗。这位自封的野兽之王是个强大的对手，所以不要被他的蠢样所迷惑，否则你将命丧在它的獠牙之下。",
	["ARCHER TOWER"] = "弓兵",
	...
	ABOMINATED_SOLDIER_PRIESTS_BARRACK_7_NAME = "奥多米内申",
	...
	ACHIEVEMENT_MIGHTY_III_DESCRIPTION = "击败10000名敌人。",
	MAP_INAPP_TEXT_1 = "一把宝石",
	["Difficulty Level"] = "难度级别",
	ABOMINATED_SOLDIER_PRIESTS_BARRACK_2_NAME = "被玷污的亨利",
	GEMS_BARREL_NAME = "一桶宝石",
	SOLDIER_RANDOM_24_NAME = "戈登",
	HERO_HUNTER_SPIRIT_DESCRIPTION_2 = "召唤幻影，每秒造成%$heroes.hero_hunter.ultimate.entity.basic_ranged.damage_min[3]%$-%$heroes.hero_hunter.ultimate.entity.basic_ranged.damage_max[3]%$点真实伤害，持续%$heroes.hero_hunter.ultimate.duration%$秒。若安雅的遗体在其附近，将会被复活。",
	FIRST_WEEK_PACK = "礼物",
	ACHIEVEMENT_SMOOTH_OPER_GATOR_DESCRIPTION = "帮助友好鳄鱼发动汽船。",
	ABOMINATED_SOLDIER_PRIESTS_BARRACK_9_NAME = "哈尔博米内申",
	...
	ENEMY_MINDLESS_HUSK_DESCRIPTION = "看似脆弱不堪的空壳，然而它们每一个都能为战场带来令人头疼的惊喜。",
	...
	ENEMY_EVOLVING_SCOURGE_EXTRA = "- 吸收阵亡单位后进化成更强形态。\n- 受到[注目]时立即进化成最终形态。",
	...
	HERO_LUMENIR_CELESTIAL_JUDGEMENT_TITLE = "神圣裁决",
	...
	ENEMY_SPIDER_SISTER_NAME = "蜘蛛姐妹",
	COMIC_7_6_KR5_KR5 = "下次再会了，我亲爱的宿敌。",
	HERO_SPIDER_ARACNID_SPAWNER_DESCRIPTION_2 = "召唤 %$heroes.hero_spider.ultimate.spawn_amount[3]%$ 只蜘蛛，为 %$heroes.hero_spider.ultimate.spider.duration[3]%$ 秒而战，命中时使敌人昏迷。",
	...
	LEVEL_8_HISTORY = "我们在深入教团领地时，发现了一系列巨大洞穴，里面充满了与诡异魔法产生共鸣的水晶。教团正在开采这些水晶，这无疑是为了充当能量来源。至于目的何在，我们尚不清楚，但干扰开采活动一定能有效地打乱他们的阵脚。",
	...
	ENEMY_AMALGAM_DESCRIPTION = "由虚空之外的生命与土壤融合而成的巨兽。行动迟缓，但能够在战场上散布恐惧。",
	Great = "伟大",
	...
	HERO_HUNTER_SPIRIT_DESCRIPTION_1 = "召唤幻影，每秒造成%$heroes.hero_hunter.ultimate.entity.basic_ranged.damage_min[2]%$-%$heroes.hero_hunter.ultimate.entity.basic_ranged.damage_max[2]%$点真实伤害，持续%$heroes.hero_hunter.ultimate.duration%$秒。若安雅的遗体在其附近，将会被复活。",
	...
	TAUNT_STAGE15_CULTIST_BEFORE_BOSSFIGHT_0005 = "虛空中沒有生命。",
	TAUNT_STAGE15_DENAS_0001 = "我还有一笔账要算。这场战斗我绝不缺席！",
	TAUNT_STAGE16_DENAS_AFTER_BOSSFIGHT_0001 = "没看出来吧？",
	HERO_LUMENIR_FIRE_BALLS_DESCRIPTION_3 = "吐息%$heroes.hero_lumenir.fire_balls.flames_count[3]%$个神圣光球，在路径上移动，并对敌人造成伤害。每个光球对每名经过的敌人造成%$heroes.hero_lumenir.fire_balls.flame_damage_min[3]%$-%$heroes.hero_lumenir.fire_balls.flame_damage_max[3]%$点真实伤害。",
	...
	TAUNT_STAGE19_BOSS_NAVIRA_START_0003 = "见识一下幽暗魔法的威力吧！",
	...
	TENTACLED_SOLDIER_PRIESTS_BARRACK_1_NAME = "林布利安",
	TENTACLED_SOLDIER_PRIESTS_BARRACK_2_NAME = "触手亨利",
	TENTACLED_SOLDIER_PRIESTS_BARRACK_3_NAME = "触手杰弗里",
	TENTACLED_SOLDIER_PRIESTS_BARRACK_4_NAME = "触手克拉斯",
	TENTACLED_SOLDIER_PRIESTS_BARRACK_5_NAME = "触须泰克",
	TENTACLED_SOLDIER_PRIESTS_BARRACK_6_NAME = "霍林布",
	SLOT_DELETE_SLOT = "删除存档？",
	TOWER_BALLISTA_1_DESCRIPTION = "作为哥布林一族强大的新设备，它至今都没塌掉简直是个奇迹。",
	TENTACLED_SOLDIER_PRIESTS_BARRACK_8_NAME = "林布德里克",
	TENTACLED_SOLDIER_PRIESTS_BARRACK_9_NAME = "哈林布",
	...
	TOWER_ARBOREAN_EMISSARY_2_NAME = "树灵使者2",
	TOWER_ARBOREAN_EMISSARY_3_DESCRIPTION = "树灵使用强大的自然魔法使他们的敌人脆弱无力。",
	TOWER_ARBOREAN_EMISSARY_3_NAME = "树灵使者3",
	...
	ENEMY_SKUNK_BOMBARDIER_SPECIAL = "攻击会削弱玩家单位。失败时自爆并造成伤害。",
	...
	TOWER_ARBOREAN_EMISSARY_4_NAME = "树灵使者4",
	...
	Achievements = "成就",
	TOWER_ARCANE_WIZARD_1_NAME = "奥术法师1",
	TOWER_ARCANE_WIZARD_2_DESCRIPTION = "精通奥术的法师，随时随地都能从容应战。",
	["HERO ROOM"] = "英雄",
	TOWER_ARCANE_WIZARD_2_NAME = "奥术法师2",
	TOWER_ARCANE_WIZARD_3_DESCRIPTION = "精通奥术的法师，随时随地都能从容应战。",
	TOWER_ARCANE_WIZARD_3_NAME = "奥术法师3",
	Tip = "提示",
	MAP_INAPP_TEXT_2 = "一袋宝石",
	TOWER_ARCANE_WIZARD_4_DISINTEGRATE_1_DESCRIPTION = "释放一束能够瞬间重创目标的光线。如目标为首领或精英怪则改为造成%$towers.arcane_wizard.disintegrate.boss_damage[1]%$点魔法伤害。",
	TOWER_ARCANE_WIZARD_4_DISINTEGRATE_2_DESCRIPTION = "技能冷却时间减少至%$towers.arcane_wizard.disintegrate.cooldown[2]%$秒。对首领或精英怪的伤害增加至%$towers.arcane_wizard.disintegrate.boss_damage[2]%$点。",
	TOWER_ARCANE_WIZARD_4_DISINTEGRATE_2_NAME = "分解射线",
	TOWER_ARCANE_WIZARD_4_DISINTEGRATE_3_DESCRIPTION = "技能冷却时间减少至%$towers.arcane_wizard.disintegrate.cooldown[3]%$秒。对首领或精英怪的伤害增加至%$towers.arcane_wizard.disintegrate.boss_damage[3]%$点。",
	...
	TOWER_ARCANE_WIZARD_4_NAME = "奥术法师4",
	["Sell Tower"] = "出售防御塔",
	...
	TOWER_BARREL_3_NAME = "制药战匠3",
	CREDITS_TITLE_09 = "画师",
	TOWER_BARREL_2_DESCRIPTION = "北国人的药剂是对抗大批敌人的强力武器。",
	...
	TOWER_BARREL_4_SKILL_BARREL_1_DESCRIPTION = "投掷一个腐蚀桶，造成%$towers.barrel.skill_barrel.explosion.damage_min[1]%$-%$towers.barrel.skill_barrel.explosion.damage_max[1]%$点物理伤害，桶留下的烟雾每秒造成%$towers.barrel.skill_barrel.poison.s_damage%$点真实伤害，持续%$towers.barrel.skill_barrel.poison.duration%$秒。",
	TOWER_BARREL_4_SKILL_BARREL_1_NAME = "不良批次",
	TOWER_BARREL_4_SKILL_BARREL_2_DESCRIPTION = "腐蚀桶爆炸造成%$towers.barrel.skill_barrel.explosion.damage_min[2]%$-%$towers.barrel.skill_barrel.explosion.damage_max[2]%$点物理伤害，烟雾每秒造成%$towers.barrel.skill_barrel.poison.s_damage%$点真实伤害，持续%$towers.barrel.skill_barrel.poison.duration%$秒。",
	...
	HERO_LUMENIR_FIRE_BALLS_DESCRIPTION_2 = "吐息%$heroes.hero_lumenir.fire_balls.flames_count[2]%$个神圣光球，在路径上移动，并对敌人造成伤害。每个光球对每名经过的敌人造成%$heroes.hero_lumenir.fire_balls.flame_damage_min[2]%$-%$heroes.hero_lumenir.fire_balls.flame_damage_max[2]%$点真实伤害。",
	TOWER_BARREL_4_SKILL_BARREL_3_DESCRIPTION = "腐蚀桶的爆炸造成%$towers.barrel.skill_barrel.explosion.damage_min[3]%$-%$towers.barrel.skill_barrel.explosion.damage_max[3]%$点物理伤害，烟雾每秒造成%$towers.barrel.skill_barrel.poison.s_damage%$点真实伤害，持续%$towers.barrel.skill_barrel.poison.duration%$秒。",
	TOWER_BARREL_4_SKILL_BARREL_3_NAME = "不良批次",
	ACHIEVEMENT_DISTURBING_THE_PEACE_NAME = "打破宁静",
	TOWER_PALADIN_COVENANT_1_NAME = "骑士殿堂1",
	LV22_MAGE_BEFORE_FIGHT_RESPONSE_03 = "你没东西吃了！",
	TOWER_BARREL_4_SKILL_WARRIOR_1_NAME = "神奇药剂",
	...
	TOWER_BARREL_4_SKILL_WARRIOR_2_NAME = "神奇药剂",
	TOWER_RAY_1_DESCRIPTION = "黑暗法师为了追寻自己的魔力上限，甘愿涉足危险而污秽的魔法。",
	TOWER_BARREL_4_SKILL_WARRIOR_3_NAME = "神奇药剂",
	LEVEL_30_HISTORY = "终于，我们到达了他们所谓的神的巢穴——一座破败不堪、被遗弃已久的神庙，在自己被遗忘的过去的重压下崩塌。对于一个被遗弃的神明来说，这是再合适不过的王座。是时候彻底消灭这些害虫，终结这场疯狂了。",
	HERO_LAVA_DOUBLE_TROUBLE_TITLE = "双倍麻烦",
	TOWER_BARREL_DESC = "北国人是精通药剂制作的大师，他们能在战斗中使用自制的药剂来对抗敌人。",
	...
	TOWER_DARK_ELF_2_NAME = "暮光长弓2",
	TOWER_DARK_ELF_3_DESCRIPTION = "无论远近强弱，皆是箭无虚发。",
	BOSS_CORRUPTED_DENAS_EXTRA = "- 召唤眼精。",
	CONFIRM_EXIT = "是否退出？",
	SPECIAL_REPAIR_HOLDER_SPIDERS_NAME = "被蛛网缠住的持有者",
	TOWER_DARK_ELF_3_NAME = "暮光长弓3",
	TOWER_DARK_ELF_4_NAME = "暮光长弓4",
	TOWER_TRICANNON_4_BOMBARDMENT_NOTE = "这才叫火力全开。",
	TOWER_DARK_ELF_4_SKILL_BUFF_1_NAME = "狩猎快感",
	TOWER_DARK_ELF_4_SKILL_BUFF_2_DESCRIPTION = "暮光长弓手每击败一名敌人，伤害提升%$towers.dark_elf.skill_buff.extra_damage_min[1]%$-%$towers.dark_elf.skill_buff.extra_damage_max[1]%$。",
	TOWER_DARK_ELF_4_SKILL_BUFF_2_NAME = "狩猎快感",
	TOWER_DARK_ELF_4_SKILL_BUFF_3_DESCRIPTION = "暮光长弓手每击败一名敌人，伤害提升%$towers.dark_elf.skill_buff.extra_damage_min[1]%$-%$towers.dark_elf.skill_buff.extra_damage_max[1]%$。",
	TOWER_DARK_ELF_4_SKILL_BUFF_3_NAME = "狩猎快感",
	...
	TOWER_DEMON_PIT_4_NAME = "恶魔熔坑4",
	HERO_SPIDER_ARACNID_SPAWNER_DESCRIPTION_3 = "召唤 %$heroes.hero_spider.ultimate.spawn_amount[4]%$ 只蜘蛛，为 %$heroes.hero_spider.ultimate.spider.duration[4]%$ 秒而战，命中时使敌人昏迷。",
	TOWER_DEMON_PIT_DESC = "这些来自熔岩深处的小恶魔会毫不犹豫地“投入”战场。",
	TOWER_DEMON_PIT_SOLDIER_NAME = "小恶魔",
	MAP_INAPP_GEM_PACK_VAULT = "一仓库宝石",
	TOWER_DWARF_1_NAME = "炮兵小队 1",
	...
	TOWER_FLAMESPITTER_2_NAME = "矮人喷火器2",
	...
	TOWER_FLAMESPITTER_3_NAME = "矮人喷火器3",
	TOWER_FLAMESPITTER_4_DESCRIPTION = "喷火器的火焰可与龙焰媲美，令敌人闻风丧胆。",
	TOWER_FLAMESPITTER_4_NAME = "矮人喷火器4",
	...
	TOWER_GHOST_3_DESCRIPTION = "神出鬼没的暗影，敌人来不及反应就已一命呜呼。",
	...
	TOWER_FLAMESPITTER_4_SKILL_COLUMNS_2_DESCRIPTION = "火柱造成%$towers.flamespitter.skill_columns.s_damage_out[2]%$-%$towers.flamespitter.skill_columns.s_damage_in[2]%$点物理伤害，使敌人眩晕%$towers.flamespitter.skill_columns.s_stun%$秒。",
	...
	TOWER_FLAMESPITTER_4_SKILL_COLUMNS_3_DESCRIPTION = "火柱造成%$towers.flamespitter.skill_columns.s_damage_out[3]%$-%$towers.flamespitter.skill_columns.s_damage_in[3]%$点物理伤害，使敌人眩晕%$towers.flamespitter.skill_columns.s_stun%$秒。",
	...
	TOWER_GHOST_2_DESCRIPTION = "神出鬼没的暗影，敌人来不及反应就已一命呜呼。",
	Resume = "返回",
	...
	TOWER_GHOST_3_NAME = "暗影守卫3",
	ENEMY_UNBLINDED_PRIEST_EXTRA = "- 高魔法抗性。\n- 被重创时转变为恶煞。",
	TOWER_GHOST_4_EXTRA_DAMAGE_1_DESCRIPTION = "暗影守卫投入战斗%$towers.ghost.extra_damage.cooldown_start%$秒后，伤害提升%$towers.ghost.extra_damage.s_damage[1]%$%。",
	TOWER_GHOST_4_EXTRA_DAMAGE_2_DESCRIPTION = "暗影守卫投入战斗%$towers.ghost.extra_damage.cooldown_start%$秒后，伤害提升%$towers.ghost.extra_damage.s_damage[2]%$%。",
	...
	TOWER_GHOST_4_EXTRA_DAMAGE_2_NAME = "能量虹吸",
	TOWER_GHOST_4_EXTRA_DAMAGE_3_DESCRIPTION = "暗影守卫投入战斗%$towers.ghost.extra_damage.cooldown_start%$秒后，伤害提升%$towers.ghost.extra_damage.s_damage[3]%$%。",
	TOWER_GHOST_4_EXTRA_DAMAGE_3_NAME = "能量虹吸",
	TOWER_GHOST_4_NAME = "暗影守卫4",
	TOWER_GHOST_4_SOUL_ATTACK_2_DESCRIPTION = "暗影守卫被击败后扑向一名敌人，造成%$towers.ghost.soul_attack.s_damage[2]%$点真实伤害，降低其速度并使其攻击伤害减半。",
	...
	TOWER_GHOST_4_SOUL_ATTACK_NOTE = "我要带上你一起！",
	TOWER_ARCANE_WIZARD_4_DISINTEGRATE_NOTE = "尘归尘，土归土。",
	ITEM_VEZNAN_WRATH_DESC = "卫兹南施放一个强大魔法，消灭每一个在战场上的敌人。",
	TOWER_GHOST_NAME = "暗影守卫",
	Credits = "制作人员",
	COMIC_15_6_KR5_KR5 = "我们可以派些精灵去帮忙，他们……",
	TOWER_HERMIT_TOAD_1_NAME = "沼泽隐士 1",
	...
	TOWER_HERMIT_TOAD_4_NAME = "沼泽隐士 4",
	...
	TOWER_HERMIT_TOAD_4_SKILL_JUMP_1_NAME = "泰山压顶 1",
	...
	ENEMY_UNBLINDED_ABOMINATION_NAME = "恶煞",
	ACHIEVEMENT_LUCAS_SPIDER_NAME = "蜘蛛卢卡斯",
	TOWER_HERMIT_TOAD_4_SKILL_JUMP_2_NAME = "泰山压顶 2",
	...
	TOWER_HERMIT_TOAD_4_SKILL_JUMP_3_NAME = "泰山压顶 3",
	...
	TOWER_NECROMANCER_1_DESCRIPTION = "通幽法师化幽能为己用，在战场上播下混乱的种子，再收割丰硕的果实。",
	TOWER_NECROMANCER_1_NAME = "通幽法师1",
	CSpeed0 = "慢",
	...
	HERO_MECHA_DEATH_FROM_ABOVE_MENUBOTTOM_NAME = "从天而降",
	TOWER_SPARKING_GEODE_1_NAME = "雷霆巨像 1",
	TOWER_NECROMANCER_2_NAME = "通幽法师2",
	ENEMY_STAGE_11_CULT_LEADER_ILLUSION_EXTRA = "- 保护敌人免受伤害。\n- 召唤黑暗触手困锁防御塔。",
	TOWER_NECROMANCER_3_DESCRIPTION = "通幽法师化幽能为己用，在战场上播下混乱的种子，再收割丰硕的果实。",
	ACHIEVEMENT_NO_FLY_ZONE_NAME = "禁飞区",
	TOWER_RAY_4_DESCRIPTION = "黑暗法师为了追寻自己的魔力上限，甘愿涉足危险而污秽的魔法。",
	TOWER_NECROMANCER_4_DESCRIPTION = "通幽法师化幽能为己用，在战场上播下混乱的种子，再收割丰硕的果实。",
	TOWER_NECROMANCER_4_NAME = "通幽法师4",
	...
	TOWER_NECROMANCER_4_SKILL_DEBUFF_1_DESCRIPTION = "放置一个图腾，持续%$towers.necromancer.skill_debuff.aura_duration[1]%$秒，诅咒敌人并使士兵的攻击伤害提升%$towers.necromancer.skill_debuff.s_damage_factor[1]%$%。",
	towers_golden_time_NAME = "黄金时间",
	TOWER_NECROMANCER_4_SKILL_DEBUFF_2_DESCRIPTION = "图腾使士兵的攻击伤害提升%$towers.necromancer.skill_debuff.s_damage_factor[2]%$%。冷却时间减少至%$towers.necromancer.skill_debuff.cooldown[2]%$秒。",
	TOWER_NECROMANCER_4_SKILL_DEBUFF_2_NAME = "诅咒图腾",
	TOWER_NECROMANCER_4_SKILL_DEBUFF_3_DESCRIPTION = "图腾使士兵的攻击伤害提升%$towers.necromancer.skill_debuff.s_damage_factor[3]%$%。冷却时间减少至%$towers.necromancer.skill_debuff.cooldown[3]%$秒。",
	HERO_BIRD_BIRDS_OF_PREY_MENUBOTTOM_DESCRIPTION = "召唤狮鹫飞到区域上空攻击敌人。",
	["HERO_DRAGON_ARB_ARBOREAN EVOLVE_MENUBOTTOM_NAME"] = "自然本性",
	ENEMY_UNBLINDED_ABOMINATION_DESCRIPTION = "完全疯狂的祭司，以在战斗中的无情而闻名。",
	TOWER_NECROMANCER_4_SKILL_DEBUFF_3_NAME = "诅咒图腾",
	LEVEL_8_IRON = "铁拳模式8",
	DAYS_ABBREVIATION = "天",
	TOWER_NECROMANCER_4_SKILL_DEBUFF_NOTE = "强盛军队！",
	TOWER_NECROMANCER_4_SKILL_RIDER_2_DESCRIPTION = "幽暗骑士造成%$towers.necromancer.skill_rider.s_damage[2]%$点真实伤害。",
	TOWER_NECROMANCER_4_SKILL_RIDER_2_NAME = "幽暗骑士",
	TOWER_NECROMANCER_4_SKILL_RIDER_3_DESCRIPTION = "幽暗骑士造成%$towers.necromancer.skill_rider.s_damage[3]%$点真实伤害。",
	TOWER_NECROMANCER_4_SKILL_RIDER_3_NAME = "幽暗骑士",
	...
	TOWER_NECROMANCER_NAME = "通幽法师",
	TOWER_BARREL_4_SKILL_WARRIOR_1_DESCRIPTION = "召唤一名喝下力量药剂的战士，其拥有%$towers.barrel.skill_warrior.entity.hp_max[1]%$点生命值，攻击可造成%$towers.barrel.skill_warrior.entity.damage_min[1]%$-%$towers.barrel.skill_warrior.entity.damage_max[1]%$点物理伤害。",
	TOWER_PALADIN_COVENANT_2_DESCRIPTION = "骑士们忠勇义烈，不遗余力地保卫着王国。",
	TOWER_PALADIN_COVENANT_2_NAME = "骑士殿堂2",
	TOWER_PALADIN_COVENANT_3_DESCRIPTION = "骑士们忠勇义烈，不遗余力地保卫着王国。",
	...
	TOWER_PALADIN_COVENANT_3_NAME = "骑士殿堂3",
	TOWER_PALADIN_COVENANT_4_DESCRIPTION = "骑士们忠勇义烈，不遗余力地保卫着王国。",
	TOWER_PALADIN_COVENANT_4_HEALING_PRAYER_1_NAME = "治愈祷告",
	ENEMY_BALLOONING_SPIDER_NAME = "气球蜘蛛",
	...
	TOWER_PALADIN_COVENANT_4_HEALING_PRAYER_NOTE = "恪尽职守，鞠躬尽瘁。",
	...
	["Victory!"] = "胜利！",
	TOWER_RAY_2_NAME = "诡术魔导师2",
	TOWER_RAY_3_NAME = "诡术魔导师3",
	TOWER_RAY_4_CHAIN_1_DESCRIPTION = "魔法射线额外连锁%$towers.ray.skill_chain.s_max_enemies%$名敌人，使其减速，造成总魔法伤害的%$towers.ray.skill_chain.damage_mult[1]%$%。",
	TOWER_DARK_ELF_4_SKILL_SOLDIERS_NOTE = "该下来耍耍了。",
	TOWER_RAY_4_CHAIN_1_NAME = "魔力溢流",
	TOWER_RAY_4_CHAIN_2_DESCRIPTION = "魔法射线额外连锁%$towers.ray.skill_chain.s_max_enemies%$名敌人，使其减速，造成总魔法伤害的%$towers.ray.skill_chain.damage_mult[2]%$%。",
	TOWER_RAY_4_CHAIN_2_NAME = "魔力溢流",
	CARD_REWARDS_UPDATE_03 = "蜘蛛恐惧症",
	TOWER_RAY_4_CHAIN_3_DESCRIPTION = "魔法射线额外连锁%$towers.ray.skill_chain.s_max_enemies%$名敌人，使其减速，造成总魔法伤害的%$towers.ray.skill_chain.damage_mult[3]%$%。",
	TOWER_RAY_4_CHAIN_3_NAME = "魔力溢流",
	TOWER_NECROMANCER_3_NAME = "通幽法师3",
	TOWER_RAY_4_NAME = "诡术魔导师4",
	TOWER_RAY_4_SHEEP_1_DESCRIPTION = "将附近的一名敌人变成绵软无力的绵羊。绵羊拥有其本体%$towers.ray.skill_sheep.sheep.hp_mult%$%的生命值。",
	...
	TOWER_RAY_4_SHEEP_2_DESCRIPTION = "将附近的一名敌人变成绵软无力的绵羊。绵羊拥有其本体%$towers.ray.skill_sheep.sheep.hp_mult%$%的生命值。",
	TOWER_RAY_4_SHEEP_2_NAME = "变形魔咒",
	TOWER_RAY_4_SHEEP_3_DESCRIPTION = "将附近的一名敌人变成绵软无力的绵羊。绵羊拥有其本体%$towers.ray.skill_sheep.sheep.hp_mult%$%的生命值。",
	...
	TOWER_ROCKET_GUNNERS_4_STING_MISSILES_1_DESCRIPTION = "发射一枚导弹，击败一名生命值低于%$towers.rocket_gunners.soldier.sting_missiles.hp_max_target[1]%$的敌人。",
	TOWER_ROCKET_GUNNERS_4_STING_MISSILES_2_DESCRIPTION = "导弹冷却时间减至%$towers.rocket_gunners.sting_missiles.cooldown[2]%$秒，可以击败生命值不多于%$towers.rocket_gunners.soldier.sting_missiles.hp_max_target[2]%$的敌人。",
	...
	TOWER_ROCKET_GUNNERS_4_STING_MISSILES_3_DESCRIPTION = "导弹冷却时间减至%$towers.rocket_gunners.sting_missiles.cooldown[3]%$秒，可以击败生命值不多于%$towers.rocket_gunners.soldier.sting_missiles.hp_max_target[3]%$的敌人。",
	TOWER_ROCKET_GUNNERS_4_STING_MISSILES_3_NAME = "蜂刺导弹",
	ACHIEVEMENT_STARLIGHT_NAME = "明辉星光",
	HERO_RAELYN_INSPIRE_FEAR_DESCRIPTION_1 = "使附近敌人眩晕%$heroes.hero_raelyn.inspire_fear.stun_duration[1]%$秒，同时降低其攻击伤害%$heroes.hero_raelyn.inspire_fear.s_inflicted_damage_factor[1]%$%，持续%$heroes.hero_raelyn.inspire_fear.damage_duration[1]%$秒。",
	...
	TOWER_ROYAL_ARCHERS_1_NAME = "皇家弓箭手1",
	TOWER_ROYAL_ARCHERS_2_DESCRIPTION = "誓死效忠王国的皇家弓箭手，擅长远程射击，能在远处保护利尼维亚的军队。",
	TOWER_ROYAL_ARCHERS_2_NAME = "皇家弓箭手2",
	heroes_desperate_effort_NAME = "知己知彼",
	TOWER_ROYAL_ARCHERS_3_NAME = "皇家弓箭手3",
	TOWER_ROYAL_ARCHERS_4_ARMOR_PIERCER_1_NAME = "穿甲射击",
	JOYSTICK_HELP_MAP_NX_B = "取消/返回",
	TOWER_ROYAL_ARCHERS_4_ARMOR_PIERCER_2_DESCRIPTION = "射出三支强化箭矢，造成%$towers.royal_archers.armor_piercer.damage_min[2]%$-%$towers.royal_archers.armor_piercer.damage_max[2]%$点物理伤害，同时无视敌人%$towers.royal_archers.armor_piercer.armor_penetration[2]%$%的护甲。",
	...
	TOWER_ROYAL_ARCHERS_4_ARMOR_PIERCER_3_DESCRIPTION = "射出三支强化箭矢，造成%$towers.royal_archers.armor_piercer.damage_min[3]%$-%$towers.royal_archers.armor_piercer.damage_max[3]%$点物理伤害，同时无视敌人%$towers.royal_archers.armor_piercer.armor_penetration[3]%$%的护甲。",
	...
	TOWER_ROYAL_ARCHERS_4_DESCRIPTION = "誓死效忠王国的皇家弓箭手，擅长远程射击，能在远处保护利尼维亚的军队。",
	MAP_INAPP_TEXT_4 = "免费宝石",
	TOWER_ROYAL_ARCHERS_4_NAME = "皇家弓箭手4",
	TOWER_BARREL_4_NAME = "制药战匠4",
	...
	TOWER_ROYAL_ARCHERS_4_RAPACIOUS_HUNTER_NOTE = "鹰眼背后暗藏生机。",
	...
	TOWER_SAND_1_NAME = "沙丘哨兵1",
	["Unlocks at Level"] = "解锁等级：",
	TOWER_SAND_3_DESCRIPTION = "哨兵炉火纯青的回旋镖功夫足以震慑任何自视甚高的佣兵。",
	TOWER_SAND_3_NAME = "沙丘哨兵3",
	towers_golden_time_DESCRIPTION = "增加提前召唤波次获得的额外金币奖励。",
	TOWER_SAND_4_NAME = "沙丘哨兵4",
	HERO_VENOM_INNER_BEAST_TITLE = "原始野性",
	TOWER_GHOST_4_SOUL_ATTACK_3_DESCRIPTION = "暗影守卫被击败后扑向一名敌人，造成%$towers.ghost.soul_attack.s_damage[3]%$点真实伤害，降低其速度并使其攻击伤害减半。",
	...
	TAUNT_LVL30_BOSS_ABILITY_10 = "操纵你的命运！",
	...
	ENEMY_CUTTHROAT_RAT_NAME = "隐身鼠",
	TOWER_SAND_4_SKILL_GOLD_2_DESCRIPTION = "镖刃造成%$towers.sand.skill_gold.s_damage[2]%$点物理伤害，击败敌人会额外产生%$towers.sand.skill_gold.gold_extra[2]%$枚金币。",
	TOWER_SAND_4_SKILL_GOLD_2_NAME = "赏金狩猎",
	TOWER_SAND_4_SKILL_GOLD_3_DESCRIPTION = "镖刃造成%$towers.sand.skill_gold.s_damage[3]%$点物理伤害，击败敌人会额外产生%$towers.sand.skill_gold.gold_extra[3]%$枚金币。",
	TOWER_SAND_4_SKILL_GOLD_3_NAME = "赏金狩猎",
	TAUNT_STAGE11_CULTIST_LEADER_FIGHT_0003 = "奥库斯·波库斯！",
	TOWER_SAND_4_SKILL_GOLD_NOTE = "悬赏写的是“不论存亡”。",
	INGAME_TUTORIAL_GOTCHA_1 = "了解了！",
	ITEM_DEATHS_TOUCH_BOTTOM_DESC = "拥有无上的力量真是太棒啦……噢，我是无敌的！",
	TOWER_NECROMANCER_2_DESCRIPTION = "通幽法师化幽能为己用，在战场上播下混乱的种子，再收割丰硕的果实。",
	TOWER_SPARKING_GEODE_2_DESCRIPTION = "雷霆巨像 3",
	TOWER_SPARKING_GEODE_2_NAME = "雷霆巨像 2",
	MAP_HEROROOM_HELP3 = "提升英雄能力！",
	TOWER_SPARKING_GEODE_3_DESCRIPTION = "晶化 1",
	TOWER_SPARKING_GEODE_3_NAME = "雷霆巨像 4",
	...
	TOWER_SPARKING_GEODE_4_CRISTALIZE_1_DESCRIPTION = "每 %$towers.sparking_geode.crystalize.cooldown[1]%$ 秒，它会将范围内的 %$towers.sparking_geode.crystalize.max_targets[1]%$ 个敌人结晶化，使其眩晕并承受 %$towers.sparking_geode.crystalize.s_received_damage_factor[1]%$% 的额外伤害。",
	TOWER_SPARKING_GEODE_4_CRISTALIZE_1_NAME = "结晶化 I",
	HERO_VESPER_ARROW_STORM_MENUBOTTOM_DESCRIPTION = "朝一片区域内倾泻大量箭矢，对敌人造成伤害。",
	ACHIEVEMENT_MIGHTY_III_NAME = "举世无双",
	TOWER_SPARKING_GEODE_4_CRISTALIZE_2_DESCRIPTION = "每 %$towers.sparking_geode.crystalize.cooldown[2]%$ 秒，它会结晶化范围内的 %$towers.sparking_geode.crystalize.max_targets[2]%$ 个敌人，使其眩晕，并使其受到 %$towers.sparking_geode.crystalize.s_received_damage_factor[2]%$% 的额外伤害。",
	TOWER_SPARKING_GEODE_4_CRISTALIZE_2_NAME = "结晶化 II",
	TOWER_SPARKING_GEODE_4_CRISTALIZE_3_DESCRIPTION = "每 %$towers.sparking_geode.crystalize.cooldown[3]%$ 秒，它会结晶化范围内的 %$towers.sparking_geode.crystalize.max_targets[3]%$ 个敌人，使其眩晕，并使其受到 %$towers.sparking_geode.crystalize.s_received_damage_factor[3]%$% 的额外伤害。",
	TOWER_SPARKING_GEODE_4_CRISTALIZE_3_NAME = "结晶化 III",
	TOWER_SPARKING_GEODE_4_CRYSTALIZE_1_DESCRIPTION = "每%$towers.sparking_geode.crystalize.cooldown[1]%$秒，它会使范围内的%$towers.sparking_geode.crystalize.max_targets[1]%$个敌人晶化，使其眩晕，并受到额外%$towers.sparking_geode.crystalize.s_received_damage_factor[1]%$%的伤害。",
	TOWER_SPARKING_GEODE_4_CRYSTALIZE_1_NAME = "晶化 I",
	TOWER_SPARKING_GEODE_4_DESCRIPTION = "风暴召唤者，混乱的认证制造者。小心它的能量消耗。",
	HERO_HUNTER_SPIRIT_DESCRIPTION_3 = "召唤幻影，每秒造成%$heroes.hero_hunter.ultimate.entity.basic_ranged.damage_min[4]%$-%$heroes.hero_hunter.ultimate.entity.basic_ranged.damage_max[4]%$点真实伤害，持续%$heroes.hero_hunter.ultimate.duration%$秒。若安雅的遗体在其附近，将会被复活。",
	...
	TOWER_SPARKING_GEODE_4_NAME = "涌动巨像 IV",
	TOWER_SPARKING_GEODE_4_SPIKE_BURST_1_DESCRIPTION = "每 %$towers.sparking_geode.spike_burst.cooldown[1]%$ 秒，哨兵召唤一个电场，对附近的敌人造成伤害并使其减速 %$towers.sparking_geode.spike_burst.duration[1]%$ 秒。",
	ENEMY_BANE_WOLF_DESCRIPTION = "要是不能及时发现这群恶狼的身影，便会沦为它们口中的猎物。",
	TOWER_SPARKING_GEODE_4_SPIKE_BURST_2_DESCRIPTION = "每 %$towers.sparking_geode.spike_burst.cooldown[2]%$ 秒，哨兵召唤一个电场，对附近的敌人造成伤害并使其减速 %$towers.sparking_geode.spike_burst.duration[2]%$ 秒。",
	...
	TOWER_SPARKING_GEODE_4_SPIKE_BURST_2_NAME = "电涌 II",
	TOWER_SPARKING_GEODE_4_SPIKE_BURST_3_DESCRIPTION = "每 %$towers.sparking_geode.spike_burst.cooldown[3]%$ 秒，哨兵召唤一个电场，对附近的敌人造成伤害并减速 %$towers.sparking_geode.spike_burst.duration[3]%$ 秒。",
	TOWER_ROCKET_GUNNERS_4_PHOSPHORIC_NOTE = "黑暗淬炼过的子弹。",
	BUTTON_RESET = "重设",
	TOWER_SPARKING_GEODE_4_SPIKE_BURST_3_NAME = "电涌 III",
	...
	SPECIAL_STAGE_11_VEZNAN_ABILITY_NAME_2 = "地狱生命",
	...
	TOWER_STAGE_28_PRIESTS_BARRACK_DESCRIPTION = "无眼者的信徒。",
	...
	HERO_VENOM_RANGED_TENTACLE_DESCRIPTION_3 = "远程攻击一名敌人，造成%$heroes.hero_venom.ranged_tentacle.s_damage[3]%$点物理伤害，并有%$heroes.hero_venom.ranged_tentacle.bleed_chance[3]%$%概率施加持续伤害。每秒造成%$heroes.hero_venom.ranged_tentacle.s_bleed_damage%$点伤害，持续%$heroes.hero_venom.ranged_tentacle.bleed_duration[3]%$秒。",
	SOLDIER_TOWER_ROCKET_GUNNERS_9_NAME = "费勒",
	TOWER_STARGAZER_4_NAME = "精灵观星者4",
	...
	TOWER_TRICANNON_1_DESCRIPTION = "一首献给战争的情歌，描述的景象对敌我而言皆是水深火热。",
	TOWER_TRICANNON_1_NAME = "三管加农炮1",
	C_REWARD = "奖励：",
	TOWER_TRICANNON_2_DESCRIPTION = "一首献给战争的情歌，描述的景象对敌我而言皆是水深火热。",
	TOWER_TRICANNON_2_NAME = "三管加农炮2",
	TOWER_TRICANNON_3_DESCRIPTION = "一首献给战争的情歌，描述的景象对敌我而言皆是水深火热。",
	PRIVACY_POLICY_ASK_AGE = "你什么时候出生？",
	TOWER_DEMON_PIT_4_BIG_DEMON_NAME = "天降魔头",
	TOWER_TRICANNON_3_NAME = "三管加农炮3",
	...
	TOWER_TRICANNON_4_DESCRIPTION = "一首献给战争的情歌，描述的景象对敌我而言皆是水深火热。",
	TOWER_TRICANNON_4_NAME = "三管加农炮4",
	...
	LEVEL_17_HISTORY = "曾经古灵精怪的仙境森林如今充满了不怀好意又毛骨悚然的气息。有消息称成群结队的沉眠精灵战士和诡秘生物正在这片土地游荡，攻击旅人，腐化森林。将军，我们必须深入调查。",
	TOWER_TRICANNON_4_OVERHEAT_3_NAME = "过热模式",
	ENEMY_GLAREBROOD_CRYSTAL_NAME = "炫目族水晶",
	...
	BOSS_PIG_NAME = "野兽之王碎辗",
	ENEMY_GLARELING_NAME = "眼精",
	ENEMY_DEATHWOOD_EXTRA = "- 精英怪。\n - 投掷诅咒果实造成范围伤害。",
	...
	HERO_HUNTER_BEASTS_DESCRIPTION_2 = "召唤2只蝙蝠对附近敌人发起攻击，持续%$heroes.hero_hunter.beasts.duration[2]%$秒，造成%$heroes.hero_hunter.beasts.damage_min[2]%$-%$heroes.hero_hunter.beasts.damage_max[2]%$点物理伤害。每只蝙蝠有一定概率从目标处获得%$heroes.hero_hunter.beasts.gold_to_steal[2]%$金币。",
	...
	["Very slow"] = "非常慢",
	Veteran = "老兵",
	TOWER_RAY_2_DESCRIPTION = "黑暗法师为了追寻自己的魔力上限，甘愿涉足危险而污秽的魔法。",
	SLOT_NAME = "存档",
	...
	TOWER_DWARF_2_NAME = "炮兵小队 2",
	INGAME_TUTORIAL_NEW_TIP = "新提示",
	TOWER_DWARF_4_DESCRIPTION = "身材娇小，一点就着，没有任何敌人能活着穿过她们的防线。",
	ACHIEVEMENT_ALL_THE_SMALL_THINGS_DESCRIPTION = "击败182个虚空瞥视者。",
	...
	ENEMY_BALLOONING_SPIDER_FLYER_NAME = "气球蜘蛛",
	...
	TOWER_BALLISTA_4_SKILL_BOMB_1_DESCRIPTION = "长距离发射一枚由废品制成的炸弹，造成%$towers.ballista.skill_bomb.damage_min[1]%$-%$towers.ballista.skill_bomb.damage_max[1]%$点物理伤害。使敌人减速%$towers.ballista.skill_bomb.duration[1]%$秒。",
	...
	HERO_SPIDER_INSTAKILL_MELEE_DESCRIPTION_1 = "每 %$heroes.hero_spider.instakill_melee.cooldown[1]%$ 秒，Spydyr 可以处决一个被击晕的敌人，其生命值低于 %$heroes.hero_spider.instakill_melee.life_threshold[1]%$。",
	...
	TOWER_BALLISTA_DESC = "哥布林一族对战斗充满执念，为了不用再拉弓射箭而研发了这座巨弩。",
	COMIC_6_1b_KR5_KR5 = "但是……我这里可容不下那东西！",
	CREDITS_SUBTITLE_07 = "（按字母顺序）",
	heroes_desperate_effort_DESCRIPTION = "英雄的攻击将无视敌人10％的抗性。",
	TOWER_ROYAL_ARCHERS_3_DESCRIPTION = "誓死效忠王国的皇家弓箭手，擅长远程射击，能在远处保护利尼维亚的军队。",
	heroes_lethal_focus_DESCRIPTION = "英雄的攻击有20％概率造成暴击伤害。",
	heroes_lethal_focus_NAME = "弱点打击",
	heroes_lone_wolves_NAME = "孤胆英雄",
	heroes_nimble_physique_DESCRIPTION = "英雄单位有20％概率能够闪避敌人的攻击。",
	...
	TOWER_DARK_ELF_4_SKILL_BUFF_1_DESCRIPTION = "暮光长弓手每击败一名敌人，伤害提升%$towers.dark_elf.skill_buff.extra_damage_min[1]%$-%$towers.dark_elf.skill_buff.extra_damage_max[1]%$。",
	...
	reinforcements_night_veil_DESCRIPTION = "暗影射手的射程变远且攻击速度增加。",
	...
	ENEMY_REVENANT_SOULCALLER_DESCRIPTION = "本该安息的精灵法师被幽暗魔法驱使着，能召唤沉眠精灵的镜像。",
	...
	reinforcements_rebel_militia_DESCRIPTION = "利尼维亚抵抗军将取代援军，利尼维亚抵抗军是身穿厚重铠甲的坚韧战士。",
	...
	HERO_DRAGON_GEM_CRYSTAL_INSTAKILL_TITLE = "紫晶石冢",
	...
	TOWER_NECROMANCER_4_SKILL_DEBUFF_1_NAME = "诅咒图腾",
	...
	HERO_ROBOT_UPPERCUT_DESCRIPTION_3 = "击败一名生命值低于%$heroes.hero_robot.uppercut.s_life_threshold[3]%$%的敌人，一拳分胜负。",
	...
	TAUNT_BOSS_PIG_FROM_POOL_0003 = "小的们，现在我们又有肉吃了！",
	C_DIFFICULTY_NORMAL = "已完成普通模式",
	ENEMY_DARKSTEEL_ANVIL_EXTRA = "- 为敌方单位提供护甲和速度增益",
	COMIC_15_4_KR5_KR5 = "你需要传递一个消息。",
	TOWER_RAY_1_NAME = "诡术魔导师1",
	alliance_flux_altering_coils_NAME = "奥术石柱",
	HERO_HUNTER_BEASTS_DESCRIPTION_1 = "召唤2只蝙蝠对附近敌人发起攻击，持续%$heroes.hero_hunter.beasts.duration[1]%$秒，造成%$heroes.hero_hunter.beasts.damage_min[1]%$-%$heroes.hero_hunter.beasts.damage_max[1]%$点物理伤害。每只蝙蝠有一定概率从目标处获得%$heroes.hero_hunter.beasts.gold_to_steal[1]%$金币。",
	HERO_SPIDER_AREA_ATTACK_DESCRIPTION_1 = "每 %$heroes.hero_spider.area_attack.cooldown[1]%$ 秒，斯派迪尔展现她的存在，使附近的敌人昏迷 %$heroes.hero_spider.area_attack.s_stun_time[1]%$ 秒。",
	ACHIEVEMENT_CONQUEROR_OF_THE_VOID_NAME = "虚空征服者",
	ENEMY_DEATHWOOD_DESCRIPTION = "被诡秘生物腐化的怪异树木，在林中游荡，肆意破坏。",
	Level = "等级",
	...
	ENEMY_SPIDERLING_DESCRIPTION = "魔法强化过后的蜘蛛，敏捷且狂暴，会狠狠咬人。",
	BOSS_CROCS_LVL5_DESCRIPTION = "饥饿的化身，如果放任这个古老的生物行动，整个世界都会被他吞噬殆尽。",
	LEVEL_10_IRON = "铁拳模式10",
	ENEMY_SURVEYOR_HARPY_DESCRIPTION = "秃鹫一直都跟随野兽军团，伺机寻觅饱餐一顿。",
	...
	HERO_SPIDER_AREA_ATTACK_TITLE = "压倒性的存在",
	TOWER_PALADIN_COVENANT_NAME = "骑士殿堂",
	HERO_SPIDER_INSTAKILL_MELEE_DESCRIPTION_2 = "每 %$heroes.hero_spider.instakill_melee.cooldown[2]%$ 秒，Spydyr 可以处决生命值低于 %$heroes.hero_spider.instakill_melee.life_threshold[2]%$ 的昏迷敌人。",
	...
	HERO_MECHA_DESC = "奥纳格罗源自两位疯狂哥布林发明家的奇思妙想，并以矮人科技作为基础打造而成，是哥布林战争机器的终极形态，对黑暗军的敌人来说，这是令人畏惧的存在。",
	ENEMY_SPIDEAD_NAME = "丝绸之女",
	LEVEL_13_MODES_UPGRADES = "最高等级5",
	HERO_HUNTER_HEAL_STRIKE_TITLE = "无情爪击",
	HERO_DRAGON_GEM_DESC = "教团在遗忘峡谷的活动打断了科斯米尔与世隔绝的生活。为了驱逐入侵者，这条晶龙与卫兹南达成协议，加入联盟对抗共同的敌人。",
	...
	ENEMY_CORRUPTED_ELF_EXTRA = "- 失败后生成一个镜像。",
	BOSS_CULT_LEADER_NAME = "泛视先知魔蒂娅丝",
	["Select and train abilities"] = "选择并训练能力",
	TOWER_FLAMESPITTER_4_SKILL_COLUMNS_1_DESCRIPTION = "地面喷发出火柱，对敌人造成%$towers.flamespitter.skill_columns.s_damage_out[1]%$-%$towers.flamespitter.skill_columns.s_damage_in[1]%$点物理伤害，使敌人眩晕%$towers.flamespitter.skill_columns.s_stun%$秒。",
	ENEMY_REVENANT_HARVESTER_NAME = "沉眠收割者",
	...
	TOWER_HERMIT_TOAD_4_SKILL_INSTAKILL_1_NAME = "黏性长舌 1",
	MAP_NEW_HERO_ALERT = "新的英雄！",
	ACHIEVEMENT_UNBOUND_VICTORY_DESCRIPTION = "在“危险路口”关卡中，确保没有任何梦魇变为武装梦魇。",
	...
	ACHIEVEMENT_NO_FLY_ZONE_DESCRIPTION = "击杀50只气球蜘蛛。",
	...
	LEVEL_29_HISTORY = "越往深处走，就越清楚这场恐怖已经在地下生长了很长时间。否则，这种迅速的扩张是难以想象的。而且，凭借我们周围日益密集的蛛网、弥漫的血腥气息以及仿佛在脖颈间喘息的黑暗来看，我敢打赌，我们正在逼近它们巢穴的核心。",
	...
	HERO_SPIDER_AREA_ATTACK_DESCRIPTION_2 = "每 %$heroes.hero_spider.area_attack.cooldown[2]%$ 秒，斯派迪尔展现她的存在，使附近的敌人昏迷 %$heroes.hero_spider.area_attack.s_stun_time[2]%$ 秒。",
	TOWER_STAGE_28_PRIESTS_BARRACK_NAME = "失明的邪教徒",
	BOSS_CULT_LEADER_DESCRIPTION = "作为教团现任的领袖，魔蒂娅丝充当全视之魔眼的副手，策划对各个世界的入侵。",
	TOWER_DWARF_4_FORMATION_1_NAME = "队伍扩充",
	TOWER_BARREL_4_DESCRIPTION = "北国人的药剂是对抗大批敌人的强力武器。",
	...
	HERO_SPIDER_INSTAKILL_MELEE_DESCRIPTION_3 = "每%$heroes.hero_spider.instakill_melee.cooldown[3]%$秒，斯派迪尔可以处决一个被震慑的敌人，其生命值低于%$heroes.hero_spider.instakill_melee.life_threshold[3]%$。",
	COMIC_4_9_KR5 = "但你的忠告是对的。",
	reinforcements_intense_workout_NAME = "强化训练",
	TOWER_DARK_ELF_CHANGE_MODE_MAXHP_NAME = "锁定：生命值上限最高。",
	ENEMY_CRYSTAL_GOLEM_EXTRA = "- 精英怪。\n- 极高护甲值。",
	LEVEL_11_HISTORY = "我们终于走出了峡谷，但前路依旧漫长。现在，我们站在一个嵌满水晶的巨型传送门前，泛视先知魔蒂娅丝已经完成了她的仪式。接下来要面临什么，我们无从知晓，但我们依旧严阵以待。全体戒备！",
	TOWER_SPARKING_GEODE_4_SPIKE_BURST_1_NAME = "电涌 I",
	LEVEL_18_HISTORY = "深叶哨站传来消息，精灵们快要无法抵御攻势了。我们必须赶快前去支援精灵部队和他们队长——艾利丹，以免为时已晚。等到保住了哨站之后，我们就可以继续前进，直至这场入侵的根源所在。",
	CREDITS_TITLE_07 = "程序员",
	COMIC_15_10_KR5_KR5 = "……但状态不太好。",
	...
	HERO_MUYRN_NAME = "尼鲁",
	ACHIEVEMENT_TURN_A_BLIND_EYE_DESCRIPTION = "击败100个在[注目]状态下的腐化怪物。",
	...
	TOWER_SPARKING_GEODE_4_SPIKE_BURST = "更强、更好、更快、更强大。",
	...
	ENEMY_REVENANT_HARVESTER_DESCRIPTION = "旧时的女祭司变成了游荡林间的怪物，她们支配诡秘生物为其所用。",
	...
	TOWER_PALADIN_COVENANT_1_DESCRIPTION = "骑士们忠勇义烈，不遗余力地保卫着王国。",
	...
	HERO_SPIDER_SUPREME_HUNTER_TITLE = "暗影步",
	TOWER_DWARF_4_FORMATION_1_DESCRIPTION = "为小队增加第三名炮兵。",
	ENEMY_BOSS_DEFORMED_GRYMBEARD_NAME = "畸变诡须",
	TOWER_PALADIN_COVENANT_4_HEALING_PRAYER_1_DESCRIPTION = "当骑士的生命值低于%$towers.paladin_covenant.healing_prayer.health_trigger_factor[1]%$%时，他将获得无敌，并每秒恢复%$towers.paladin_covenant.healing_prayer.s_healing[1]%$点生命值，持续%$towers.paladin_covenant.healing_prayer.duration%$秒。",
	C_DIFFICULTY_EASY = "已完成休闲模式",
	HERO_DRAGON_GEM_CLASS = "不灭晶龙",
	HERO_RAELYN_ULTIMATE_ENTITY_NAME = "黑暗骑士",
	HERO_VENOM_FLOOR_SPIKES_TITLE = "锐利尖刺",
	["Heroic challenge"] = "英雄挑战",
	ENEMY_UNBLINDED_PRIEST_DESCRIPTION = "游走于现实与神秘学之间的祭司，操控着黑暗魔法步入战场。",
	...
	Iron = "钢铁",
	LEVEL_7_HISTORY = "阻止野兽族夷平永辉森林后，我们追踪在背后推波助澜的教团，来到一片荒凉之地。我们怀疑这就是他们实施秘密计划的据点。敌在暗，我在明，必须小心为上……他们似乎有一些不为人知的本事。",
	HERO_DRAGON_BONE_NAME = "波恩哈特",
	ENEMY_EVOLVING_SCOURGE_DESCRIPTION = "乍看有点可愛，但当它们吸收掉阵亡的战士时就会变成混世魔王。",
	...
	ENEMY_UNBLINDED_PRIEST_NAME = "教团祭司",
	...
	HERO_DRAGON_GEM_CRYSTAL_INSTAKILL_DESCRIPTION_1 = "将一名敌人困在水晶中数秒后爆炸，立即击败目标并对其周围造成%$heroes.hero_dragon_gem.crystal_instakill.s_damage[1]%$点真实伤害。",
	SHOP_ROOM_MOST_POPULAR_TITLE = "热门",
	TOWER_PALADIN_COVENANT_4_LEAD_1_DESCRIPTION = "将一名骑士替换为卫队老将，为附近的友方单位提供%$towers.paladin_covenant.lead.soldier_veteran.s_aura_damage_buff_factor%$%的攻击伤害增益。",
	...
	DISCOUNT = "折扣",
	HERO_HUNTER_BEASTS_DESCRIPTION_3 = "召唤2只蝙蝠对附近敌人发起攻击，持续%$heroes.hero_hunter.beasts.duration[3]%$秒，造成%$heroes.hero_hunter.beasts.damage_min[3]%$-%$heroes.hero_hunter.beasts.damage_max[3]%$点物理伤害。每只蝙蝠有一定概率从目标处获得%$heroes.hero_hunter.beasts.gold_to_steal[3]%$金币。",
	MENU_HUD_WAVES = "%i/%i",
	JOYSTICK_CONFIG_FIRST_REPEAT_DELAY = "重复延迟",
	LEVEL_11_TITLE = "11.峡谷高原",
	COMIC_6_5_KR5_KR5 = "你这宇宙鼻涕虫……",
	TOWER_NECROMANCER_4_SKILL_RIDER_1_NAME = "幽暗骑士",
	HERO_SPIDER_AREA_ATTACK_DESCRIPTION_3 = "每隔 %$heroes.hero_spider.area_attack.cooldown[3]%$ 秒，Spydyr展现她的存在，使附近的敌人昏迷 %$heroes.hero_spider.area_attack.s_stun_time[3]%$ 秒。",
	...
	HERO_BIRD_DESC = "英勇的狮鹫骑士挥舞着钢铁与火药的军械飞入战场。布卢登对于黑暗大军曾侵袭他的家园心有芥蒂，但他仍然加入联盟，希望能摧毁教团，恢复利尼维亚的和平安宁。",
	ENEMY_VILE_SPAWNER_NAME = "眼巢",
	...
	HERO_LUMENIR_FIRE_BALLS_DESCRIPTION_1 = "吐息%$heroes.hero_lumenir.fire_balls.flames_count[1]%$个神圣光球，在路径上移动，并对敌人造成伤害。每个光球对每名经过的敌人造成%$heroes.hero_lumenir.fire_balls.flame_damage_min[1]%$-%$heroes.hero_lumenir.fire_balls.flame_damage_max[1]%$点真实伤害。",
	...
	TOWER_GHOST_DESC = "即便失去实体也继续战斗的暗影守卫，能在阴影中穿梭，出其不意地削弱对手。",
	LEVEL_14_IRON = "铁拳模式14",
	ACHIEVEMENT_OVER_THE_EDGE_NAME = "游戏结束",
	ACHIEVEMENT_GARBAGE_DISPOSAL_NAME = "垃圾处理",
	ENEMY_CORRUPTED_ELF_DESCRIPTION = "沉眠于地下的精灵，能击败远处的敌人。即便过了很久也是精英战士。",
	...
	TAUNT_LVL30_BOSS_ABILITY_02 = "坚持住！哇哈哈哈！",
	ACHIEVEMENT_INTO_THE_OGREVERSE_NAME = "不友好的邻居",
	ACHIEVEMENT_DARK_RUTHLESSNESS_DESCRIPTION = "仅使用黑暗大军阵营防御塔和英雄的情况下赢得任一关卡。",
	HERO_BIRD_SHOUT_STUN_TITLE = "震慑尖啸",
	...
	LEVEL_9_HISTORY = "这些坑道曲折蜿蜒，令人晕头转向，但我们确信走对了路，因为教团的活动愈发频繁。随着我们逐渐深入，各种景象映入眼帘，这不禁让人怀疑教团内部的癫狂程度究竟有多深。",
	ACHIEVEMENT_SPECTRAL_FURY_DESCRIPTION = "击败凡里埃，遏止重生精灵军团的攻势。",
	...
	HERO_VENOM_RANGED_TENTACLE_TITLE = "深度追猎",
	...
	HERO_LUMENIR_DESC = "卢米妮尔翱翔于诸界之间，作为正义与决心的化身屹立不倒。她是传说中的光明使者，受到利尼维亚骑士们的崇敬，她向骑士们赐予祝福，赋予他们强大的力量，以助他们在对抗黑暗的战斗中无往不利。",
	...
	Yes = "好",
	TOWER_GHOST_1_NAME = "暗影守卫1",
	LEVEL_3_HISTORY = "我们及时赶回了森林之心，但野兽族已突破防线。打起精神，加固阵地！不惜一切代价保护森林之心，否则森林和树灵族必将遭遇灭顶之灾。",
	TOWER_SELL = "出售防御塔",
	ACHIEVEMENT_MIGHTY_II_DESCRIPTION = "击败3000名敌人。",
	...
	TAUNT_TUTORIAL_ARBOREAN_ALL_0001 = "继续！你是我们的希望 ！",
	...
	TAUNT_LVL30_BOSS_ABILITY_07 = "我的地盘，我的规则！",
	BUTTON_RESTART = "重新开始",
	...
	TAUNT_STAGE19_BOSS_NAVIRA_FIGHT_0005 = "颤抖吧，我的子嗣已经醒来！",
	...
	TOWER_ROCKET_GUNNERS_DESC = "这支特种部队在地面和空中都能够独立作战，用先进的武器对敌人发起奇袭。",
	TOWER_BALLISTA_4_SKILL_FINAL_SHOT_NOTE = "小子，你这是中头奖了！",
	TOWER_TRICANNON_DESC = "黑暗军研制的多管加农炮，降下火焰与毁灭，重新定义了现代冲突。",
	HERO_HUNTER_SPIRIT_MENUBOTTOM_DESCRIPTION = "召唤幻影，减速并攻击敌人。",
	CREDITS_TITLE_02_LEAD_GAME_DESIGNERS = "首席游戏设计师",
	HERO_SPIDER_TUNNELING_DESCRIPTION_1 = "斯派迪尔的挖掘现在在重新浮出时造成 %$heroes.hero_spider.tunneling.damage_min[1]%$-%$heroes.hero_spider.tunneling.damage_max[1]%$ 伤害。",
	...
	TOWER_ROYAL_ARCHERS_1_DESCRIPTION = "誓死效忠王国的皇家弓箭手，擅长远程射击，能在远处保护利尼维亚的军队。",
	QUIT = "退出",
	...
	ACHIEVEMENT_PLAYFUL_FRIENDS_DESCRIPTION = "在森林之心与所有树灵玩一玩“挖洞”游戏。",
	...
	TOWER_GHOST_4_SOUL_ATTACK_1_DESCRIPTION = "暗影守卫被击败后扑向一名敌人，造成%$towers.ghost.soul_attack.s_damage[1]%$点真实伤害，降低其速度并使其攻击伤害减半。",
	...
	TOWER_GHOST_4_DESCRIPTION = "神出鬼没的暗影，敌人来不及反应就已一命呜呼。",
	ACHIEVEMENTS = "成就",
	...
	TAUNT_LVL30_BOSS_INTRO_03 = "就在同一天！哈哈哈哈！",
	NOTIFICATION_title_new_tip = "新提示",
	CArmor1 = "低",
	ENEMY_DEFORMED_GRYMBEARD_CLONE_EXTRA = "- 飞行单位\n- 高魔法抗性护盾",
	HERO_DRAGON_GEM_CRYSTAL_INSTAKILL_DESCRIPTION_3 = "将一名敌人困在水晶中数秒后爆炸，立即击败目标并对其周围造成%$heroes.hero_dragon_gem.crystal_instakill.s_damage[3]%$点真实伤害。",
	ENEMY_CUTTHROAT_RAT_SPECIAL = "击中敌人后进入隐形状态。",
	LEVEL_15_TITLE = "15.恶视魔塔",
	ENEMY_CROCS_EGG_SPAWNER_NAME = "鳄鱼运巢者",
	LEVEL_10_HISTORY = "原来教团利用开采的水晶，在峡谷外建造了一个外观诡异的法器。它嗡嗡作响，充满怪异的能量，连周围的空气都显得格外沉重。在我们继续深入之前绝不能留此祸害。",
	...
	TOWER_NECROMANCER_4_SKILL_RIDER_1_DESCRIPTION = "召唤一名幽暗骑士向前冲锋，对经过的敌人造成%$towers.necromancer.skill_rider.s_damage[1]%$点真实伤害。",
	...
	HERO_RAELYN_BRUTAL_SLASH_TITLE = "精准打击",
	...
	HERO_SPIDER_SUPREME_HUNTER_DESCRIPTION_2 = "眨眼之间，斯派迪尔瞬移至生命值最高的敌人，对其造成 %$heroes.hero_spider.supreme_hunter.damage_min[2]%$-%$heroes.hero_spider.supreme_hunter.damage_max[2]%$ 伤害。",
	...
	LEVEL_12_HISTORY = "我们迎回了迪纳斯国王，并一起穿过传送门踏入未知世界。这个奇异的世界看起来像是利尼维亚的扭曲倒影，但却是满目疮痍。小心脚下，潜伏在黑暗中的东西可比教团还要可怕。",
	TOWER_SAND_2_DESCRIPTION = "哨兵炉火纯青的回旋镖功夫足以震慑任何自视甚高的佣兵。",
	INGAME_TUTORIAL_SKIP = "跳过！",
	SPECIAL_ARBOREAN_SENTINELS_SPEARMEN_NAME = "树灵荆棘矛兵",
	ENEMY_BALLOONING_SPIDER_FLYER_DESCRIPTION = "快速而狡猾的蜘蛛，擅长避开麻烦。",
	...
	TOWER_SAND_DESC = "来自战锤要塞的沙丘哨兵可谓是沙漠中最厉害的佣兵。",
	...
	ACHIEVEMENT_MIGHTY_I_DESCRIPTION = "击败500名敌人。",
	...
	HERO_MECHA_MINE_DROP_DESCRIPTION_2 = "英雄静止时，机甲会定期在路径上安放至多%$heroes.hero_mecha.mine_drop.max_mines[2]%$枚爆炸地雷。每枚地雷的爆炸会造成%$heroes.hero_mecha.mine_drop.damage_min[2]%$-%$heroes.hero_mecha.mine_drop.damage_max[2]%$点爆炸伤害。",
	CReload4 = "非常快",
	...
	TAUNT_BOSS_PIG_FROM_POOL_0005 = "我很乐意见证你的失败。",
	["Skip this!"] = "跳过！",
	...
	HERO_RAELYN_DESC = "威风凛凛的蕾琳，生来就是为了率领黑暗骑士冲锋陷阵，直面敌军锋芒。她的冷静与不屈赢得了卫兹南的认可，也令利尼维亚人闻风丧胆。好勇斗狠的她成为了第一位自愿加入黑暗巫师麾下的人。",
	...
	ENEMY_ARMORED_NIGHTMARE_DESCRIPTION = "拜腐化魔法所赐，这些梦魇身披盔甲，昂首挺胸地投入战斗。",
	...
	ENEMY_REVENANT_HARVESTER_EXTRA = "- 把附近的诡秘生物转化为沉眠收割者。",
	...
	TAUNT_STAGE18_ERIDAN_FIGHT_0001 = "今夜开始狩猎。",
	...
	HERO_SPIDER_SUPREME_HUNTER_DESCRIPTION_3 = "眨眼之间，斯派迪尔瞬移至生命值最高的敌人，对其造成 %$heroes.hero_spider.supreme_hunter.damage_min[3]%$-%$heroes.hero_spider.supreme_hunter.damage_max[3]%$ 伤害。",
	...
	ENEMY_BALLOONING_SPIDER_FLYER_EXTRA = "- 被逼入绝境时开始飞行\n- 中等护甲",
	...
	ENEMY_HYENA5_SPECIAL = "吸收倒下的友军能量恢复血量。",
	ACHIEVEMENT_HAIL_TO_THE_K_BABY_DESCRIPTION = "找到鳄鱼国王。",
	TOWER_BARREL_1_DESCRIPTION = "北国人的药剂是对抗大批敌人的强力武器。",
	HERO_SPIDER_TUNNELING_DESCRIPTION_3 = "斯派迪尔的挖掘现在在重新浮出时造成 %$heroes.hero_spider.tunneling.damage_min[3]%$-%$heroes.hero_spider.tunneling.damage_max[3]%$ 伤害。",
	TAUNT_STAGE19_BOSS_NAVIRA_FIGHT_0003 = "我甚至会选择……",
	...
	TOWER_GHOST_1_DESCRIPTION = "神出鬼没的暗影，敌人来不及反应就已一命呜呼。",
	...
	HERO_RAELYN_INSPIRE_FEAR_DESCRIPTION_3 = "使附近敌人眩晕%$heroes.hero_raelyn.inspire_fear.stun_duration[3]%$秒，同时降低其攻击伤害%$heroes.hero_raelyn.inspire_fear.s_inflicted_damage_factor[3]%$%，持续%$heroes.hero_raelyn.inspire_fear.damage_duration[3]%$秒。",
	...
	HERO_HUNTER_BEASTS_TITLE = "黄昏演出",
	JOYSTICK_CONFIG_REPEAT_DELAY = "重复延迟",
	HERO_HUNTER_ULTIMATE_ENTITY_NAME = "幻影",
	ACHIEVEMENT_OUTBACK_BARBEQUICK_DESCRIPTION = "在不可能难度下，在碎辗跳跃前击败它。",
	...
	HERO_VENOM_EAT_ENEMY_DESCRIPTION_3 = "格里姆森带走一个生命值低于 %$heroes.hero_venom.eat_enemy.hp_trigger%$% 的敌人，同时恢复自身总生命值的 %$heroes.hero_venom.eat_enemy.regen[3]%$%。",
	ENEMY_MAD_TINKERER_EXTRA = "- 使用其他单位留下的废铁制造无人机",
	ENEMY_BOSS_GRYMBEARD_NAME = "诡须",
	ENEMY_ACOLYTE_TENTACLE_DESCRIPTION = "作为最后手段，随从们会将力量献给全视之魔眼，从而召唤出强力的触手。",
	["You can always change the difficulty in the options menu."] = "你可以随时在选项菜单中更改难度级别。",
	BOSS_NAVIRA_DESCRIPTION = "汎里埃沾染了禁忌之力，失去了女神恩典，企图借助幽暗魔法重铸精灵一族的荣耀。",
	...
	HERO_ROBOT_DESC = "黑暗大军的锻造大师们，凭借丰富经验突破极限，创造出一台名为“战争巨头”的战争机械。这台由炽热引擎驱动的无情机器在战场上横扫一切，无论友军还是敌人都不会放在眼里。",
	...
	ACHIEVEMENT_WOBBA_LUBBA_DUB_DUB_NAME = "睿克和默蒂",
	ERROR_MESSAGE_GENERIC = "哎呀！出错了。",
	ENEMY_TOWER_RAY_SHEEP_DESCRIPTION = "咩。",
	COMIC_7_5_2_KR2 = "没有",
	SOLDIER_HERO_DRAGON_ARB_SPAWN_PARAGON_LVL1_NAME = "树灵楷模",
	HERO_RAELYN_BRUTAL_SLASH_DESCRIPTION_1 = "用她的剑大力劈砍，造成%$heroes.hero_raelyn.brutal_slash.s_damage[1]%$点真实伤害。",
	...
	TOWER_ROYAL_ARCHERS_4_ARMOR_PIERCER_1_DESCRIPTION = "射出三支强化箭矢，造成%$towers.royal_archers.armor_piercer.damage_min[1]%$-%$towers.royal_archers.armor_piercer.damage_max[1]%$点物理伤害，同时无视敌人%$towers.royal_archers.armor_piercer.armor_penetration[1]%$%的护甲。",
	...
	ENEMY_BEAR_VANGUARD_DESCRIPTION = "他们高大、威猛且残暴，能轻易击败敌人。",
	...
	ABOMINATED_SOLDIER_PRIESTS_BARRACK_1_NAME = "被玷污的威利",
	ACHIEVEMENT_RUNEQUEST_NAME = "符文寻旅",
	BUTTON_TO_BATTLE_2 = "战斗",
	ACHIEVEMENT_HAIL_TO_THE_K_BABY_NAME = "向鳄鱼国王致敬，宝贝！",
	HERO_VESPER_ARROW_TO_THE_KNEE_DESCRIPTION_2 = "射出一支利箭，眩晕敌人%$heroes.hero_vesper.arrow_to_the_knee.stun_duration[2]%$秒，同时造成%$heroes.hero_vesper.arrow_to_the_knee.s_damage[2]%$点物理伤害。",
	LEVEL_8_IRON_UNLOCK = "三管加农炮\n骑士殿堂",
	TAUNT_LVL30_BOSS_INTRO_01 = "Sarelgaz, Mactanz... 复仇的时刻到了...",
	...
	HERO_SPIDER_DESC = "Spydyr是暮光精灵组织中最后的幸存者，他们的任务是消灭蜘蛛女王的邪教。凭借暗影魔法和狩猎技巧，她被视为林尼埃拉最致命的刺客之一。",
	...
	TAUNT_LVL30_BOSS_PREFIGHT_03 = "陷入女王的网中了！",
	HERO_BIRD_EAT_INSTAKILL_DESCRIPTION_1 = "狮鹫俯冲地面，带走一名生命值不超过%$heroes.hero_bird.eat_instakill.hp_max[1]%$的敌人。",
	...
	HERO_SPIDER_ARACNID_SPAWNER_TITLE = "猎人的召唤",
	COMIC_11_3_KR5_KR5 = "…步步逼近，蓄势待发…",
	TOWER_BARREL_3_DESCRIPTION = "北国人的药剂是对抗大批敌人的强力武器。",
	...
	TAUNT_STAGE19_BOSS_NAVIRA_FIGHT_0001 = "我掌控一切生命！",
	ACHIEVEMENT_WE_ARE_ALL_MAD_HERE_NAME = "我们都看错了",
	...
	HERO_VENOM_DESC = "教团没能把佣兵格里姆森变成恶煞，便只能将他囚禁起来。这段痛苦的经历意外赐予了格里姆森变形的能力，他利用这份力量挣脱了控制，并发誓有朝一日必将归来，完成复仇。",
	BUTTON_YES = "是",
	...
	TOWER_NECROMANCER_DESC = "通幽法师掌握着最黑暗的魔法，能将敌人转化为幽暗军团的一员。",
	ENEMY_NOXIOUS_HORROR_DESCRIPTION = "外表看似两栖生物的怪物，会向猎物喷射有毒胆汁。近战时也同样危险。",
	SECONDS_ABBREVIATION = "秒",
	HERO_RAELYN_BRUTAL_SLASH_DESCRIPTION_2 = "用她的剑大力劈砍，造成%$heroes.hero_raelyn.brutal_slash.s_damage[2]%$点真实伤害。",
	...
	HERO_DRAGON_GEM_CRYSTAL_INSTAKILL_DESCRIPTION_2 = "将一名敌人困在水晶中数秒后爆炸，立即击败目标并对其周围造成%$heroes.hero_dragon_gem.crystal_instakill.s_damage[2]%$点真实伤害。",
	...
	ENEMY_CULTBROOD_EXTRA = "- 迅速\n- 毒攻击\n- 如果敌人中毒死亡，会诞生另一个Cultbrood",
	...
	LEVEL_28_HISTORY = "顺着我们侦察兵留下的线索，我们发现了一条通向那些被诅咒的邪教徒的踪迹。看来他们找到了新的神明崇拜——一个邪恶的、织网的怪物……但现在谁来庇护他们都无关紧要。这一次，我们要彻底消灭他们。",
	towers_favorite_customer_NAME = "贵宾待遇",
	JOYSTICK_HELP_MAP_NX_L = "上一级/页",
	HERO_BIRD_CLUSTER_BOMB_TITLE = "强力轰炸",
	...
	ENEMY_SPECTER_DESCRIPTION = "纵使身体腐朽，但依旧无法解脱，注定了要侵扰生者。",
	...
	HERO_SPIDER_SUPREME_HUNTER_DESCRIPTION_1 = "眨眼之间，斯派迪尔瞬移至生命值最高的敌人，对其造成 %$heroes.hero_spider.supreme_hunter.damage_min[1]%$-%$heroes.hero_spider.supreme_hunter.damage_max[1]%$ 伤害。",
	OFFER_OFF = "关闭",
	...
	ACHIEVEMENT_ARACHNED_NAME = "永别武器",
	JOYSTICK_HELP_MAP_A = "选择",
	COMIC_4_7b_KR5 = "你！！！",
	COMIC_15_5_KR5_KR5 = "我们应该派遣更多侦察兵。这些邪教徒四处游荡，我们无法安心。",
	JOYSTICK_HELP_INGAME_NX_PLUS = "暂停/继续",
	HERO_BIRD_EAT_INSTAKILL_DESCRIPTION_2 = "狮鹫俯冲地面，带走一名生命值不超过%$heroes.hero_bird.eat_instakill.hp_max[2]%$的敌人。",
	START = "开始",
	LEVEL_SELECT_AVAILABLE_TOWERS = "可用防御塔",
	COMIC_5_6_KR5_KR5 = "他醒了！",
	heroes_limit_pushing_NAME = "突破极限",
	ENEMY_ANIMATED_ARMOR_DESCRIPTION = "过往战斗留下的残破遗物，被诡秘生物附身，再次加入战斗。",
	...
	HERO_MECHA_MINE_DROP_DESCRIPTION_1 = "英雄静止时，机甲会定期在路径上安放至多%$heroes.hero_mecha.mine_drop.max_mines[1]%$枚爆炸地雷。每枚地雷的爆炸会造成%$heroes.hero_mecha.mine_drop.damage_min[1]%$-%$heroes.hero_mecha.mine_drop.damage_max[1]%$点爆炸伤害。",
	...
	ACHIEVEMENT_PROMOTION_DENIED_DESCRIPTION = "在教团祭司变身成恶煞之前，击败30名教团祭司。",
	Heroic = "英雄模式",
	Skills = "技能",
	HERO_RAELYN_BRUTAL_SLASH_DESCRIPTION_3 = "用她的剑大力劈砍，造成%$heroes.hero_raelyn.brutal_slash.s_damage[3]%$点真实伤害。",
	...
	SPECIAL_SOLDIER_TOWER_ELVEN_BARRACK_3_NAME = "精灵雇佣兵 3",
	ENEMY_CROCS_BASIC_EXTRA = "- 近战",
	HERO_VENOM_CREEPING_DEATH_TITLE = "生命蔓延",
	TOWER_SPARKING_GEODE_NAME = "雷霆巨像",
	...
	TOWER_RAY_DESC = "卫兹南的学徒们利用强大魔力，向敌人施放带来痛苦的黑暗射线。",
	...
	HERO_RAELYN_INSPIRE_FEAR_DESCRIPTION_2 = "使附近敌人眩晕%$heroes.hero_raelyn.inspire_fear.stun_duration[2]%$秒，同时降低其攻击伤害%$heroes.hero_raelyn.inspire_fear.s_inflicted_damage_factor[2]%$%，持续%$heroes.hero_raelyn.inspire_fear.damage_duration[2]%$秒。",
	...
	ENEMY_HYENA5_DESCRIPTION = "以多打少的战士，随时瞄准敌方弱点。",
	...
	HERO_SPIDER_TUNNELING_TITLE = "挖掘",
