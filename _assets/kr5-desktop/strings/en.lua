return {
	...
	HERO_WUKONG_GIANT_STAFF_DESCRIPTION_1 = "Tumbles and enlarges the Jingu Bang to stomp an intercepted enemy, instanly killing it and dealing %$heroes.hero_wukong.giant_staff.area_damage.damage_min[1]%$-%$heroes.hero_wukong.giant_staff.area_damage.damage_max[1]%$ true damage in an area around the target. %$heroes.hero_wukong.giant_staff.cooldown[1]%$s cooldown.",
	HERO_WUKONG_GIANT_STAFF_DESCRIPTION_2 = "Tumbles and enlarges the Jingu Bang to stomp an intercepted enemy, instanly killing it and dealing %$heroes.hero_wukong.giant_staff.area_damage.damage_min[2]%$-%$heroes.hero_wukong.giant_staff.area_damage.damage_max[2]%$ true damage in an area around the target. %$heroes.hero_wukong.giant_staff.cooldown[2]%$s cooldown.",
	HERO_WUKONG_GIANT_STAFF_DESCRIPTION_3 = "Tumbles and enlarges the Jingu Bang to stomp an intercepted enemy, instanly killing it and dealing %$heroes.hero_wukong.giant_staff.area_damage.damage_min[3]%$-%$heroes.hero_wukong.giant_staff.area_damage.damage_max[3]%$ true damage in an area around the target. %$heroes.hero_wukong.giant_staff.cooldown[3]%$s cooldown.",
	HERO_WUKONG_GIANT_STAFF_TITLE = "Jingu Bang Technique",
	HERO_WUKONG_HAIR_CLONES_DESCRIPTION_1 = "Summons 2 hair clones of Sun Wukong to fight at his side. They deal %$heroes.hero_wukong.hair_clones.soldier.melee_attack.damage_min[1]%$-%$heroes.hero_wukong.hair_clones.soldier.melee_attack.damage_max[1]%$ true damage and last for %$heroes.hero_wukong.hair_clones.soldier.duration[1]%$ seconds. %$heroes.hero_wukong.hair_clones.cooldown[1]%$s cooldown.",
	HERO_WUKONG_HAIR_CLONES_DESCRIPTION_2 = "Summons 2 hair clones of Sun Wukong to fight at his side. They deal %$heroes.hero_wukong.hair_clones.soldier.melee_attack.damage_min[2]%$-%$heroes.hero_wukong.hair_clones.soldier.melee_attack.damage_max[2]%$ true damage and last for %$heroes.hero_wukong.hair_clones.soldier.duration[2]%$ seconds. %$heroes.hero_wukong.hair_clones.cooldown[2]%$s cooldown.",
	HERO_WUKONG_HAIR_CLONES_DESCRIPTION_3 = "Summons 2 hair clones of Sun Wukong to fight at his side. They deal %$heroes.hero_wukong.hair_clones.soldier.melee_attack.damage_min[3]%$-%$heroes.hero_wukong.hair_clones.soldier.melee_attack.damage_max[3]%$ true damage and last for %$heroes.hero_wukong.hair_clones.soldier.duration[3]%$ seconds. %$heroes.hero_wukong.hair_clones.cooldown[3]%$s cooldown.",
	HERO_WUKONG_HAIR_CLONES_TITLE = "Hair Clones",
	HERO_WUKONG_NAME = "Sun Wukong",
	HERO_WUKONG_POLE_RANGED_DESCRIPTION_1 = "Launches the Jingu Bang into the air, multiplying it into %$heroes.hero_wukong.pole_ranged.pole_amounts[1]%$ poles that fall onto enemies, each dealing %$heroes.hero_wukong.pole_ranged.damage_min[1]%$ true damage and stunning enemies in a small area for %$heroes.hero_wukong.pole_ranged.stun_duration%$s. %$heroes.hero_wukong.pole_ranged.cooldown[1]%$s cooldown.",
	HERO_WUKONG_POLE_RANGED_DESCRIPTION_2 = "Launches the Jingu Bang into the air, multiplying it into %$heroes.hero_wukong.pole_ranged.pole_amounts[2]%$ poles that fall onto enemies, each dealing %$heroes.hero_wukong.pole_ranged.damage_min[2]%$ true damage and stunning enemies in a small area for %$heroes.hero_wukong.pole_ranged.stun_duration%$s. %$heroes.hero_wukong.pole_ranged.cooldown[2]%$s cooldown.",
	HERO_WUKONG_POLE_RANGED_DESCRIPTION_3 = "Launches the Jingu Bang into the air, multiplying it into %$heroes.hero_wukong.pole_ranged.pole_amounts[3]%$ poles that fall onto enemies, each dealing %$heroes.hero_wukong.pole_ranged.damage_min[3]%$ true damage and stunning enemies in a small area for %$heroes.hero_wukong.pole_ranged.stun_duration%$s. %$heroes.hero_wukong.pole_ranged.cooldown[3]%$s cooldown.",
	HERO_WUKONG_POLE_RANGED_TITLE = "Pole Barrage",
	HERO_WUKONG_ULTIMATE_DESCRIPTION_1 = "The White Dragon and its clone burst into the ground with tremendous force, dealing %$heroes.hero_wukong.ultimate.damage_total[2]%$ true damage and leaving a slowing area lasting %$heroes.hero_wukong.ultimate.slow_duration[2]%$s. %$heroes.hero_wukong.ultimate.cooldown[2]%$s cooldown.",
	HERO_WUKONG_ULTIMATE_DESCRIPTION_2 = "The White Dragon and its two clones burst into the ground with tremendous force, dealing %$heroes.hero_wukong.ultimate.damage_total[3]%$ true damage and leaving a slowing area lasting %$heroes.hero_wukong.ultimate.slow_duration[3]%$s. %$heroes.hero_wukong.ultimate.cooldown[3]%$s cooldown.",
	HERO_WUKONG_ULTIMATE_DESCRIPTION_3 = "The White Dragon and its three clones burst into the ground with tremendous force, dealing %$heroes.hero_wukong.ultimate.damage_total[4]%$ true damage and leaving a slowing area lasting %$heroes.hero_wukong.ultimate.slow_duration[4]%$s. %$heroes.hero_wukong.ultimate.cooldown[4]%$s cooldown.",
	...
	HERO_WUKONG_ZHU_APPRENTICE_DESCRIPTION_1 = "Zhu Bajie, Sun Wukong's loyal companion follows him everywhere. Deals %$heroes.hero_wukong.zhu_apprentice.melee_attack.damage_min[1]%$-%$heroes.hero_wukong.zhu_apprentice.melee_attack.damage_max[1]%$ physical damage and has a chance to deal a big area damage attack dealing %$heroes.hero_wukong.zhu_apprentice.smash_attack.damage_min[1]%$-%$heroes.hero_wukong.zhu_apprentice.smash_attack.damage_max[1]%$ physical damage. %$heroes.hero_wukong.zhu_apprentice.dead_lifetime%$s respawn time.",
	HERO_WUKONG_ZHU_APPRENTICE_DESCRIPTION_2 = "Zhu Bajie, Sun Wukong's loyal companion follows him everywhere. Deals %$heroes.hero_wukong.zhu_apprentice.melee_attack.damage_min[2]%$-%$heroes.hero_wukong.zhu_apprentice.melee_attack.damage_max[2]%$ physical damage and has a chance to deal a big area damage attack dealing %$heroes.hero_wukong.zhu_apprentice.smash_attack.damage_min[2]%$-%$heroes.hero_wukong.zhu_apprentice.smash_attack.damage_max[2]%$ physical damage. %$heroes.hero_wukong.zhu_apprentice.dead_lifetime%$s respawn time.",
	HERO_WUKONG_ZHU_APPRENTICE_DESCRIPTION_3 = "Zhu Bajie, Sun Wukong's loyal companion follows him everywhere. Deals %$heroes.hero_wukong.zhu_apprentice.melee_attack.damage_min[3]%$-%$heroes.hero_wukong.zhu_apprentice.melee_attack.damage_max[3]%$ physical damage and has a chance to deal a big area damage attack dealing %$heroes.hero_wukong.zhu_apprentice.smash_attack.damage_min[3]%$-%$heroes.hero_wukong.zhu_apprentice.smash_attack.damage_max[3]%$ physical damage. %$heroes.hero_wukong.zhu_apprentice.dead_lifetime%$s respawn time.",
	...
	TOWER_PANDAS_4_FIERY_1_DESCRIPTION = "Casts a firebolt dealing %$towers.pandas.soldier.teleport.damage_min[1]%$-%$towers.pandas.soldier.teleport.damage_max[1]%$ true damage and teleporting affected enemies back along the path. %$towers.pandas.soldier.teleport.cooldown[1]%$s cooldown.",
	TOWER_PANDAS_4_FIERY_1_NAME = "Nether Flame",
	TOWER_PANDAS_4_FIERY_2_DESCRIPTION = "Casts a firebolt dealing %$towers.pandas.soldier.teleport.damage_min[2]%$-%$towers.pandas.soldier.teleport.damage_max[2]%$ true damage and teleporting affected enemies back along the path. %$towers.pandas.soldier.teleport.cooldown[2]%$s cooldown.",
	TOWER_PANDAS_4_FIERY_2_NAME = "Nether Flame",
	TOWER_PANDAS_4_HAT = "One hat to hit them all.",
	TOWER_PANDAS_4_HAT_1_DESCRIPTION = "Launches her sharpened hat at an enemy, ricocheting %$towers.pandas.soldier.hat.max_bounces[1]%$ times between foes for %$towers.pandas.soldier.hat.damage_levels[1].min%$-%$towers.pandas.soldier.hat.damage_levels[1].max%$ true damage with each hit. %$towers.pandas.soldier.hat.cooldown[1]%$s cooldown.",
	TOWER_PANDAS_4_HAT_1_NAME = "Hat Trick",
	TOWER_PANDAS_4_HAT_2_DESCRIPTION = "Launches her sharpened hat at an enemy, ricocheting %$towers.pandas.soldier.hat.max_bounces[2]%$ times between foes for %$towers.pandas.soldier.hat.damage_levels[2].min%$-%$towers.pandas.soldier.hat.damage_levels[2].max%$ true damage with each hit. %$towers.pandas.soldier.hat.cooldown[2]%$s cooldown.",
	TOWER_PANDAS_4_HAT_2_NAME = "Hat Trick",
	TOWER_PANDAS_4_NAME = "Bamboo Masters IV",
	TOWER_PANDAS_4_THUNDER = "Panda Kombat.",
	TOWER_PANDAS_4_THUNDER_1_DESCRIPTION = "Calls down lightning strikes on a small area, each dealing %$towers.pandas.soldier.thunder.damage_min[1]%$-%$towers.pandas.soldier.thunder.damage_max[1]%$ area true damage and briefly stunning enemies hit for %$towers.pandas.soldier.thunder.stun_duration%$s. %$towers.pandas.soldier.thunder.cooldown[1]%$s cooldown.",
	TOWER_PANDAS_4_THUNDER_1_NAME = "Lightning Overload",
	TOWER_PANDAS_4_THUNDER_2_DESCRIPTION = "Calls down lightning strikes on a small area, each dealing %$towers.pandas.soldier.thunder.damage_min[2]%$-%$towers.pandas.soldier.thunder.damage_max[2]%$ area true damage and briefly stunning enemies hit for %$towers.pandas.soldier.thunder.stun_duration%$s. %$towers.pandas.soldier.thunder.cooldown[2]%$s cooldown.",
	...
	TOWER_PANDAS_RETREAT_DESCRIPTION = "Retreat standing pandas to refuge for %$towers.pandas.soldier.retreat_duration%$ seconds.",
	...
	Towers = "Towers",
	towers_favorite_customer_DESCRIPTION = "When buying the final level of a skill, reduce its cost by 50% or 20% if level 1.",
	...
	ITEM_KR4_HERO_ALLERIA_BOTTOM_INFO = "Summon Alleria Swiftwind the Elf Princess to fight alongside you.",
	ITEM_KR4_HERO_ALLERIA_DESC = "Silent as the night, light as a feather, and deadly beautiful. Too many have fallen for her charming gaze, and many more to her fatal bow.",
	...
	HERO_ELVES_DENAS_NAME = "Prince Denas the Previous",
	...
	ITEM_HERO_BEASTMASTER_NAME = "Cronan the Beastmaster",
	...
	ITEM_HERO_MONKEY_GOD_BOTTOM_DESC = "Summon Saitam the Monkey God to defeat your enemies.",
	ITEM_HERO_MONKEY_GOD_BOTTOM_INFO = "Summon Saitam the Monkey God to fight alongside you.",
	ITEM_HERO_MONKEY_GOD_DESC = "Quick to laugh, quick to anger, quick to forgive and even quicker to beat his enemies. A joyful force of good with a bit of a mischievous side, the Monkey God will make you pay if you mess with his sacred grounds.",
	ITEM_HERO_MONKEY_GOD_NAME = "Saitam the Monkey God",
	HERO_MONK_NAME = "Kutsao",
	ITEM_HERO_MONK_BOTTOM_DESC = "Summon Monk Kutsao to defeat your enemies.",
	ITEM_HERO_MONK_BOTTOM_INFO = "Summon Monk Kutsao to fight alongside you.",
	ITEM_HERO_MONK_DESC = "Kutsao's martial arts have attained perfection. He never confines himself to fixed forms, but moves with his heart and adapts to his enemy.",
	ITEM_HERO_MONK_NAME = "Monk Kutsao",
	HERO_VAMPIRESS_NAME = "Lucrezia",
	ITEM_HERO_VAMPIRESS_NAME = "Lucrezia the Vampire Princess",
	ITEM_HERO_VAMPIRESS_BOTTOM_DESC = "Summon Lucrezia the Vampire Princess to defeat your enemies.",
	ITEM_HERO_VAMPIRESS_BOTTOM_INFO = "Summon Lucrezia the Vampire Princess to fight alongside you.",
	ITEM_HERO_VAMPIRESS_DESC = "The daughter of the Vampire Lord Vasily, yet the thread of fate inextricably entwined her with Dante, the vampire hunter—the natural enemy of her kind.",
	HERO_ELVES_FAUSTUS_NAME = "Faustus",
	ITEM_HERO_FAUSTUS_NAME = "Faustus the Dragon Mage",
	ITEM_HERO_FAUSTUS_BOTTOM_DESC = "Summon Faustus the Dragon Mage to defeat your enemies.",
	ITEM_HERO_FAUSTUS_BOTTOM_INFO = "Summon Faustus the Dragon Mage to fight alongside you.",
	ITEM_HERO_FAUSTUS_DESC = "Rumors say he was a close friend of the Goddess Ainani, while others claim that on the night Faustus was born, a star in the Draco constellation dimmed...Regardless, Faustus has mastered nearly all known draconic spells—yet one of them remains a mystery...",
	...
	ITEM_HERO_BOLVERK_NAME = "Bolverk the Varl Berserker",
	ITEM_HERO_BOLVERK_BOTTOM_DESC = "Summon Bolverk the Varl Berserker to defeat your enemies.",
	ITEM_HERO_BOLVERK_BOTTOM_INFO = "Summon Bolverk the Varl Berserker to fight alongside you.",
	ITEM_HERO_BOLVERK_DESC = "The Varl were once a mighty people, but now their bloodline nears its end. Bolverk is among the last of these few—the final berserker of his kind.",
	HERO_JACK_O_LANTERN_NAME = "Jack O'Lantern",
	HERO_JACKO_GHOUL_NAME = "Ghoul",
	...
	TOWER_DEEP_DEVILS_NAME = "Deep Devil's Reef",
	TOWER_DEEP_DEVILS_DESC = "Bluegales have emerged from the depths to punish their enemies with their magical blasts while Greenfins fight and stop them on the ground.",
	TOWER_DEEP_DEVILS_1_NAME = "Deep Devil's Reef I",
	TOWER_DEEP_DEVILS_1_DESCRIPTION = "From the depths of the sea, Bluegales emerge to zap enemies while Greenfins stop them in place.",
	TOWER_DEEP_DEVILS_2_NAME = "Deep Devil's Reef II",
	TOWER_DEEP_DEVILS_2_DESCRIPTION = "From the depths of the sea, Bluegales emerge to zap enemies while Redspines stop them in place.",
	TOWER_DEEP_DEVILS_3_NAME = "Deep Devil's Reef III",
	TOWER_DEEP_DEVILS_3_DESCRIPTION = "From the depths of the sea, Bluegales emerge to zap enemies while Redspines stop them in place.",
	TOWER_DEEP_DEVILS_4_NAME = "Deep Devil's Reef IV",
	TOWER_DEEP_DEVILS_4_DESCRIPTION = "From the depths of the sea, Bluegales emerge to zap enemies while Redspines stop them in place.",
	TOWER_DEEP_DEVILS_4_TENTANGLES_NOTE = "Tangled",
	TOWER_DEEP_DEVILS_4_TENTANGLES_1_NAME = "NET THROW",
	TOWER_DEEP_DEVILS_4_TENTANGLES_2_NAME = "NET THROW II",
	TOWER_DEEP_DEVILS_4_TENTANGLES_1_DESCRIPTION = "Redspines can now toss nets to trap enemies for 2 seconds. 14s cooldown.",
	TOWER_DEEP_DEVILS_4_TENTANGLES_2_DESCRIPTION = "Redspines can now toss nets to trap enemies for 4 seconds. 12s cooldown.",
	TOWER_DEEP_DEVILS_4_CHOSEN_NOTE = "We are the warriors of the deep",
	TOWER_DEEP_DEVILS_4_CHOSEN_1_NAME = "CHOSEN OF THE SEA",
	TOWER_DEEP_DEVILS_4_CHOSEN_1_DESCRIPTION = "Improve the stats of the Redspines.",
	TOWER_DEEP_DEVILS_4_STORM_NOTE = "Feel the Thunder",
	TOWER_DEEP_DEVILS_4_STORM_1_NAME = "PERFECT STORM",
	TOWER_DEEP_DEVILS_4_STORM_2_NAME = "PERFECT STORM II",
	TOWER_DEEP_DEVILS_4_STORM_3_NAME = "PERFECT STORM III",
	TOWER_DEEP_DEVILS_4_STORM_1_DESCRIPTION = "Summons a cloud over an enemy, and it deals up to 125 magical damage in 5 seconds. %$towers.deep_devils.storm.cooldown%$s cooldown.",
	TOWER_DEEP_DEVILS_4_STORM_2_DESCRIPTION = "Summons a cloud over an enemy, and it deals up to 250 magical damage in 5 seconds. %$towers.deep_devils.storm.cooldown%$s cooldown.",
	TOWER_DEEP_DEVILS_4_STORM_3_DESCRIPTION = "Summons a cloud over an enemy, and it deals up to 375 magical damage in 5 seconds. %$towers.deep_devils.storm.cooldown%$s cooldown.",
	DEEP_DEVILS_SOLDIER_1_NAME = "Etula",
	DEEP_DEVILS_SOLDIER_2_NAME = "Antha",
	DEEP_DEVILS_SOLDIER_3_NAME = "Rekar",
	DEEP_DEVILS_SOLDIER_4_NAME = "Elhith",
	DEEP_DEVILS_SOLDIER_5_NAME = "Irucza",
	DEEP_DEVILS_SOLDIER_6_NAME = "Midas",
	DEEP_DEVILS_SOLDIER_7_NAME = "Vanarka",
	TOWER_OGRES_NAME = "Ogre Shipwreck",
	TOWER_OGRES_DESC = "A wrecked ship commanded by despicable Warmongers. These battle-hungry maniacs love to fight using group tactics to overwhelm their opponents.",
	TOWER_OGRES_BARRACK_LVL1_NAME = "Ogre Shipwreck I",
	TOWER_OGRES_BARRACK_LVL1_DESCRIPTION = "Warmongers of the sea with a variety of crewmates. The fight-eager ogre comes first.",
	TOWER_OGRES_BARRACK_LVL2_NAME = "Ogre Shipwreck II",
	TOWER_OGRES_BARRACK_LVL2_DESCRIPTION = "Warmongers of the sea with a variety of crewmates. The dagger-loving goblin joins second.",
	TOWER_OGRES_BARRACK_LVL3_NAME = "Ogre Shipwreck III",
	TOWER_OGRES_BARRACK_LVL3_DESCRIPTION = "Warmongers of the sea with a variety of crewmates. The sharpshooter is third to show.",
	TOWER_OGRES_BARRACK_LVL4_NAME = "Ogre Shipwreck IV",
	TOWER_OGRES_BARRACK_LVL4_DESCRIPTION = "Warmongers of the sea with a variety of crewmates. Their cannons are ready to blow enemies away.",
	TOWER_OGRES_BARRACK_LVL4_BETTER_CREW_NOTE = "Start the party, fellas!",
	TOWER_OGRES_BARRACK_LVL4_BETTER_CREWS_1_NAME = "Better Crew",
	TOWER_OGRES_BARRACK_LVL4_BETTER_CREWS_1_DESCRIPTION = "The Crew's Barracks are better equipped for combat, increasing their Damage and acquiring Armor.",
	TOWER_OGRES_BARRACK_LVL4_GOBLIN_LAUNCHER_NOTE = "Don't let the little fella out the party!",
	TOWER_OGRES_BARRACK_LVL4_GOBLIN_LAUNCHER_1_NAME = "Goblin Launcher",
	TOWER_OGRES_BARRACK_LVL4_GOBLIN_LAUNCHER_1_DESCRIPTION = "The cannon is loaded with a goblin, firing him every %$towers.ogres.goblin_launcher.cooldowns[1]%$ seconds to fight till exhaustion.",
	TOWER_OGRES_BARRACK_LVL4_GOBLIN_LAUNCHER_2_NAME = "Goblin Launcher",
	TOWER_OGRES_BARRACK_LVL4_GOBLIN_LAUNCHER_2_DESCRIPTION = "The cannon is loaded with a goblin, firing him every %$towers.ogres.goblin_launcher.cooldowns[2]%$ seconds to fight till exhaustion.",
	TOWER_OGRES_BARRACK_LVL4_MUSKET_RAGE_NOTE = "Always bring a gun to a knife fight",
	TOWER_OGRES_BARRACK_LVL4_MUSKET_RAGE_1_NAME = "Musket Rage",
	TOWER_OGRES_BARRACK_LVL4_MUSKET_RAGE_1_DESCRIPTION = "Every %$towers.ogres.musket_rage.cooldowns[1]%$ seconds, the Musket fires a burst of bullets that deal 14 physical damage each.",
	TOWER_OGRES_BARRACK_LVL4_MUSKET_RAGE_2_NAME = "Musket Rage",
	TOWER_OGRES_BARRACK_LVL4_MUSKET_RAGE_2_DESCRIPTION = "Every %$towers.ogres.musket_rage.cooldowns[2]%$ seconds, the Musket fires a burst of bullets that deal 28 physical damage each.",
	PIRATES_SOLDIER_GOBLIN_DECKHAND_LVL2_NAME = "Goblin Deckhand",
	PIRATES_SOLDIER_GOBLIN_LAUNCHED_NAME = "Gorrel",
	...
	ELVES_BABY_ASHBITE_FIREBREATH_SMALL_DESCRIPTION_1 = "Spews forth a cone of searing flame, dealing 150 area true damage. 8s cooldown.",
	ELVES_BABY_ASHBITE_FIREBREATH_SMALL_DESCRIPTION_2 = "Spews forth a cone of searing flame, dealing 270 area true damage. 8s cooldown.",
	ELVES_BABY_ASHBITE_FIREBREATH_SMALL_DESCRIPTION_3 = "Spews forth a cone of searing flame, dealing 390 area true damage. 8s cooldown.",
	ELVES_BABY_ASHBITE_NAME = "Baby Red Dragon",
	ELVES_BABY_ASHBITE_SMOKEBREATH_NAME_1 = "Fiery Mist",
	ELVES_BABY_ASHBITE_SMOKEBREATH_NOTE = "The red mist descends!",
	ELVES_BABY_ASHBITE_SMOKEBREATH_SMALL_DESCRIPTION_1 = "Sends out a cloud of searing smoke that burns and slows enemies. 10s cooldown.",
	...
	ELVES_BABY_BERESAD_DESCRIPTION = "This black sleeping baby dragon is very fond of gold.",
	ELVES_BABY_BERESAD_NAME = "Baby Black Dragon",
	ELVES_BABY_BERESAD_SPECIAL_NAME_1 = "Conflagration",
	ELVES_BABY_BERESAD_SPECIAL_NOTE = "Reign of fire!",
	ELVES_BABY_BERESAD_SPECIAL_SMALL_DESCRIPTION_1 = "Burn the whole path with deadly dragon firebreath.",
	...
	LEVEL_101_TITLE = "101. Southport",
	LEVEL_102_HISTORY = "Good job! Your diligent investigations have revealed that it was not mere brigands terrorizing Southport, but organized bands of goblins and orcs! Now, their forward troops are creeping towards the defenseless rural communities North of Southport. We must establish an efficient and swift defense!",
	LEVEL_102_TITLE = "102. The Outskirts",
	LEVEL_103_HISTORY = "While your men celebrate your victory over the goblinoid and orcish troops, a messenger bears bad news. The township of Pagras is under siege by an overwhelmingly superior force. This is clearly an attack on the Kingdom: war is upon us!",
	LEVEL_103_TITLE = "103. Pagras",
	LEVEL_104_HISTORY = "Enemy troops are marching from the East through the Stonecliff Mountains. This can only mean that Hammerhold has fallen, and our Kingdom's capital is in peril. Our scouts conclude that the best place to stop our enemy's advance is at the Twin Rivers pass.",
	LEVEL_104_TITLE = "104. Twin River Pass",
	LEVEL_105_HISTORY = "With Twin Rivers Pass blocked, and after days of marching, we've finally reached the Silveroak Forest outpost... only to find its troop compliment decimated! The garrison's men have endured several attacks recently, and their scouts report an even greater enemy force approaching. Good thing elite ranger units are on the way to help us...",
	LEVEL_105_TITLE = "105. Silveroak Forest",
	LEVEL_106_HISTORY = "After several days of travel, we have arrived at our capital city of Linirea. The time has come to make a stand, and defend Linirea's southern walls. In addition to your highly experienced units, the King adds two units to your batallions. The arcane wizards will provide superior firepower, and the pious paladins will inspire the troops with their bravery.",
	LEVEL_106_TITLE = "106. The Citadel",
	LEVEL_107_HISTORY = "Our capital is safe, thanks to you, General! Now, our good King has entrusted you with the mission of creating a safe passage through the mountains so that we may strike at Valardul, and defeat Vez'nan and his armies. The first step in your journey will be the Coldstep Mines, which were abandoned years ago, and are now home to the Ha'kraj troll tribes. To aid you in your mission, you will be joined by a brigade of His Majesty's Royal Musketeers.",
	LEVEL_107_TITLE = "107. Coldstep Mines",
	LEVEL_108_HISTORY = "There is no place colder in these mountains than Icewind Pass, but we must advance. Our men have been besieged by Ha'kraj trolls for days, and our scouts report enemy troop movements around us... and something else, something wilder. If we are to make a stand here, this is a good place to install some of our new Artillery emplacements, and to construct a Barbarian Mead Hall so we may entertain our more... colorful troops.",
	LEVEL_108_TITLE = "108. Icewind Pass",
	LEVEL_109_HISTORY = "Arriving at the Stormcloud temple has been the best thing to happen to us in days! The Stormcloud Sorcerers will now be at your command, General, and they can open a portal straight to Valardul. However, we must provide them with a defense while they complete their spell. Something... abominable is aproaching, and the men are extremely nervous...",
	LEVEL_109_TITLE = "109. Stormcloud Temple",
	LEVEL_110_HISTORY = "We have arrived at the dreadful realm of Valardul. This is a barren and forsaken land, where the wretched souls of the departed find no solace. Pray to the gods that this place does not take its toll on your men's spirits...",
	LEVEL_110_TITLE = "110. The Wastes",
	LEVEL_111_HISTORY = "Threading through the Forsaken Valley will not be an easy task! We are near the end of our journey, and although our men are tired, they are filled with honorable purpose. But beware... this is a land riddled with Rock and Fire Titans... best not to upset them!",
	LEVEL_111_TITLE = "111. Forsaken Valley",
	LEVEL_112_HISTORY = "Our troops gather around the dread wizard Vez'nan's tower. It is time for a reckoning... time for the final fray. This is the ultimate battle for our kingdom's safety. Every step has brought us to this moment; and there is no turning back. Now it's time to show our mettle!",
	LEVEL_112_TITLE = "112. The Dark Tower",
	LEVEL_113_HISTORY = "General! We have need of you and your brave men! The late Vez'nan's causes trouble from beyond the grave. While you were battling him, he sent one of his hordes to wake up one of the dreaded spider queens, Sarelgaz! We thought the spider queens would never wake up again, but Sarelgaz has, and with her powers over darkness she's taken control of Vez'nan's remaining troops. You must vanquish them, and slay Sarelgaz!",
	LEVEL_113_TITLE = "113. Sarelgaz's Lair",
	LEVEL_114_HISTORY = "Defender of Linirea! The realm is at peace, but evil does not rest! Our agents report that the Ruins of Acaroth have been invaded by orc and goblinoid hordes. Gul'Thak, a new orcish warlord has taken advantage of the power vacuum left by Vez'nan, and his forces are terrorizing the area. You must drive these invaders away from the ruins!",
	LEVEL_114_TITLE = "114. Ruins Of Acaroth",
	LEVEL_115_HISTORY = "Summon your troops, General! The forces of darkness are relentless in their attacks against our beloved kingdom, and we must take action. Reports indicate that the area known as the Rotten Forest is indeed rotten; as a portal to the netherworld has opened in the midst of the woods. The dead find no rest in this forest, and vegetation turns against any who wander into it. You must lead your forces into the Rotten Forest and get to the root of the problem!",
	LEVEL_115_TITLE = "115. Rotten Forest",
	LEVEL_116_HISTORY = "General, you must once more rouse your troops, and protect our kingdom from its enemies! Scout reports indicate that a vicious band of delinquents is amassing far into the depths of Hushwood. Yes, Hushwood, where few of our citizens dare wander... but you are no mere citizen! Lead your forces into the woods, and vanquish these miscreants. Make them rue the day they decided to embark on a life of crime!",
	LEVEL_116_TITLE = "116. Hushwood",
	LEVEL_117_HISTORY = "Great job! You've managed to put those dastardly delinquents on the run. The combined might of your units has crushed most of their roaming forces, but they're fleeing deeper into the forest. We have reason to believe that they have a secret lair inside the woods, and that's where they keep their loot. Pursue them, draw them out of their lair, and recover the loot. Forewarned, criminals this successful probably have a cunning escape plan!",
	LEVEL_117_TITLE = "117. Bandit's Lair",
	LEVEL_118_HISTORY = "Pack your winter gear, troops; we're heading for the Glacial Heights! The locals have reported some disturbances, and our King commands we march upon the heights to investigate these reports. Watch out, because the heights have become the icy tomb of many an unprepared explorer. You might freeze to death, that is, if the savage Ha'Kraj trolls don't get you first!",
	LEVEL_118_TITLE = "118. Glacial Heights",
	LEVEL_119_HISTORY = "We now know the northern disturbances were caused by Ulguk-Hai, the Troll Warlord! This despicable beast has united all the Ha'Kraj Troll clans under his blood-red banner! If we don't stop him, his forces will descend from the North and menace the good citizens of Linirea. Prepare to fight the amassed ferocity of the Ha'Kraj nation, and face their vicious leader in his home turf!",
	LEVEL_119_TITLE = "119. Ha'Kraj Plateau",
	LEVEL_120_HISTORY = "Demons have ravaged our troops stationed at Vez'nan's tower, leaving a lone survivor... From his terrified mumbling we've learned that these hellish hordes rose from the depths of the Rift of Cinders. General, you must secure the area, discover the true origin of this threat, and make sure we have truly prevailed over Vez'nan.",
	LEVEL_120_TITLE = "120. Pit Of Fire",
	LEVEL_121_HISTORY = "We face Moloch, one of the Great Demon Lords. Our sages have discovered that it was he who opened the portal, leading to Pandaemonium, a fearsome hellish plane. You have sworn to follow your King even into hell itself... and that's exactly where you're going...",
	LEVEL_121_TITLE = "121. Pandaemonium",
	LEVEL_122_HISTORY = "There's no rest for the wicked... and thus, none for the good guys either. A messenger eagle has arrived from the Elven garrison in the Rotten Forest. The woods are still corrupted by evil, and our Elven allies are repelling attacks by horrible monsters. A new dark power is rising, attempting to expand its domain beyond the forest's depths. Hurry, General, we must go assist our Elven friends, and forever vanquish evil from that ancient forest!",
	LEVEL_122_TITLE = "122. Fungal Forest",
	LEVEL_123_HISTORY = "General, our Kingdom is in peril once again! King Banesti, of neighbouring Niroma was on his way here for the \"Great Tournament of the Kingdoms\", but he was captured at Mournful Valley. His people would never forgive us if something happened to the elderly sovereign, it could lead to war between our two realms! The fastest route to the valley is, I'm afraid, the Royal Roadway, through the infamous Rotwick.",
	LEVEL_123_TITLE = "123. Rotwick",
	LEVEL_124_HISTORY = "We'll look back fondly on that ambush at Rotwick, for now the Royal Road brings us to the Necropolis! As our men make their way through ancient crypts and ransacked tombs, they grow restless with the staggering amount of open graves. The preternatural silence only makes it worse, as it is undoubtedly but a preamble to another attack by the forces of darkness.",
	LEVEL_124_TITLE = "124. Ancient Necropolis",
	LEVEL_125_HISTORY = "You will not find many places viler than the disgusting bog we must cross to get to Lord Blackburn's castle. Gathered witches fill the air with their unseemly chanting, which meshes perfectly with the cries of wild, hungry animals. These are the beings that serve a once great, noble knight. From the putrid waters, dozens of dead bodies stare at us with empty eyes...",
	LEVEL_125_TITLE = "125. Nightfang Swale",
	LEVEL_126_HISTORY = "Sadness overtakes our hearts as we lay our eyes on a fallen champion. So deeply did Lord Blackburn yearn for the power to battle evil, that it corrupted him, sinking his lands into the grip of darkness. Alas, he cannot be saved; but we have arrived just in time to rescue good King Banesti from being hanged. General, you hold the key to the peace between the kingdoms... defeat Lord Blackburn, and perhaps death will give him a measure of redemption!",
	LEVEL_126_TITLE = "126. Castle Blackburn",
	LEVEL_201_HISTORY = "Defender of Linirea! Your services are once more required, as evil forces are attacking the ancient stronghold of Hammerhold! It hasn't been attacked in a long time... and now it's once again under siege by nomadic desert tribes! Take command of the kingdom's forces, and defend us!",
	LEVEL_201_TITLE = "201. Hammerhold",
	LEVEL_202_HISTORY = "In the midst of all the confusion, Lord Malagar stole the powerful Hammer of Ages from Hammerhold! Our outposts east of the fortress report he's fled in that direction, and they are facing him as we speak, delaying his escape. We must hurry, General, and go to their aid!",
	LEVEL_202_TITLE = "202. Sandhawk Hamlet",
	LEVEL_203_HISTORY = "Our armies have amassed under your command, as we pursue Lord Malagar across the Azsare desert! We have followed his trail to the Sape Oasis, one of the few green spots in this wasteland. As such, the nomad tribes do not take kindly to trespassers, so don't provoke the desert's fiercest denizens, the Duskar!",
	LEVEL_203_TITLE = "203. Sape Oasis",
	LEVEL_204_HISTORY = "It seems the attack at Sape Oasis was merely a distraction, and Lord Malagar has escaped towards Buccaneer's Den. We have no choice but to cross the treacherous Dunes of Despair. There is no time to go around them, so beware of the shifting sands, as the mysterious beasts crawling through them have caused the doom of many an experienced explorer!",
	LEVEL_204_TITLE = "204. Dunes of Despair",
	LEVEL_205_HISTORY = "Behold Buccaneer's Den! Nowhere else will you find a worse collection of unruly freebooters and dastardly pirates… and nowhere but here will you find a better crew to sail the Crystal Sea. After greasing some dirty palms we've learned that Lord Malagar has boarded a ship towards The Gates of Nazeru. Hiring a crew, however, will have to wait, as an enemy fleet is heading toward us. Ahoy!",
	LEVEL_205_TITLE = "205. Buccaneer's Den",
	LEVEL_206_HISTORY = "We have arrived at the legendary Gates of Nazeru, which block passage to the lost lands. Something foul is at play here, and the troops are nervous. Not the roving enemy war bands we've seen, our men can handle those... Fortunately, the Archmage Guild is here to aid us in opening the Gates, and we'll have them on our side if battle breaks out.",
	LEVEL_206_TITLE = "206. Nazeru's Gates",
	LEVEL_207_HISTORY = "The mighty Templar Order joins us as we reach the breathtaking Crimson Valley, a name it's earned for being the Ma'qwa tribe's hunting grounds. We've established a base camp here and given the men some time off to rest and recover, but we must remain vigilant. None of us has ever seen one of the Ma'qwa, but the rumors about them are... unsettling, to say the least.",
	LEVEL_207_TITLE = "207. Crimson Valley",
	LEVEL_208_HISTORY = "Scouting troops inform us that Lord Malagar heads east, to the city of Ma'qwa Urqu, beyond the Za'golon river. The only way there is through the Snapvine Bridge, built long ago by the Barrington-Keynes Expedition. Our newest allies, the Tuk'va tribe, are sworn enemies of the Ma'qwa, and they warn us about the vegetation… it seems to have something of an appetite around these parts…",
	LEVEL_208_TITLE = "208. Snapvine Bridge",
	LEVEL_209_HISTORY = "On our way to Ma'qwa Urqu, the jungle keeps getting deadlier. As if the tangled maze of roots, trees, and snapvines that have never known the sun's kiss weren't enough, something darker lurks within the thick rainforest. The men feel as if they're being hunted by something not of this world… Almost as unsettling are the necromancers we've enlisted. However, their being against Lord Malagar's plans only stresses the urgency of stopping him.",
	LEVEL_209_TITLE = "209. Lost Jungle",
	LEVEL_210_HISTORY = "Cast your gaze upon the ancient city of Ma'qwa Urqu, home to the sinister man-eating tribe that has become our enemy! Hear the battle drums and dark shamanic chanting that emanate from its mountaintop perch, feel the heat from that dangerous volcano; this is their place of power! To pursue our dreaded foe, we must first get through the Ma'qwa forces surrounding the city. Good thing our Dwarven engineers and their gnomish tinkerer cousins have cooked up a mighty mechanical surprise…",
	LEVEL_210_TITLE = "210. Ma'qwa Urqu",
	LEVEL_211_HISTORY = "We have him surrounded! The Temple of Saqra will be Lord Malagar's last stand! The Ma'qwa are even fiercer here, where they worship their crocodile-visaged deity, and their own Warlord King is leading them now. The combined might of the Ma'qwa and their leader's magics is quite possibly the most impressive array of savagery evil might ever assembled! Fight back with all your prowess, my men, lest we end up as sacrifices to Saqra… or worse.",
	LEVEL_211_TITLE = "211. Temple of Saqra",
	LEVEL_212_HISTORY = "It seems that the Temple of Saqra was merely the entrance to a vast underground labyrinth, carved into the mountain rock itself! There might just be some truth to the legends that warn about an unspeakable evil here… We must head into the maze, for our mission cannot be abandoned. If only the overwhelming darkness were all we had to face…",
	LEVEL_212_TITLE = "212. The Underpass",
	LEVEL_213_HISTORY = "We have been off marching through this stone labyrinth for days without sign of the enemy... until now. Our trackers have found the enemy's trail... but the deeper we go, the hotter it gets! Ancient glyphs on the walls tell us we're heading into the Halls of Beresad, and if the legends are true, we'll get an even warmer reception...",
	LEVEL_213_TITLE = "213. Beresad's Lair",
	LEVEL_214_HISTORY = "We've almost run out of supplies, morale is at an all-time low, and some of our men have deserted. Luckily, we've bumped into a Dwarven mining crew that dug too deep and have barricaded themselves against the Saurians. They've promised to join us in finding our way out of this damned place. Our escape must wait, as we and our newfound allies must repel the oncoming Saurian horde!",
	LEVEL_214_TITLE = "214. The Dark Descent",
	LEVEL_215_HISTORY = "This is it! The final battle against Lord Malagar and his forces is at hand! The dark ritual to unleash his evil master is underway! General, the fate of the world rests upon your shoulders. We have travelled through forsaken lands, far beyond the frontiers of our kingdom, in the deadliest of journeys, and only your shining example and exceptional tactics have brought us this far. Only you can see this quest through, and vanquish our enemies. FOR LINIREA!",
	LEVEL_215_TITLE = "215. Emberspike Depths",
	LEVEL_216_HISTORY = "For the past few weeks, sailors and fishermen have raised the alarm regarding eerie disappearances. Ships and people have been reported missing, vanishing mysteriously in nearby waters. Our Port Tortuga garrison, in the Pirate Islands, is requesting our aid. We are still unsure of who or what is behind the disappearances, but our coastal villages are in danger, and our King is asking you to lead a small rapid response fleet to get to the bottom of this new menace.",
	LEVEL_216_TITLE = "216. Port Tortuga",
	LEVEL_217_HISTORY = "Beware the Deep Devils! We believed these cruel fiends destroyed decades ago by the Linirean Royal Fleet and the Corsair Brotherhood. After the Battle of Port Tortuga, on the verge of being sunk by treacherous tides and the constant attacks of these nasty creatures, we have come ashore in the dangerous Storm Atoll. Here we prepare for battle, near the ruins of a shrine to Regnos, Lord of the Sea. Pray that Regnos will protect Linirea's defenders!",
	LEVEL_217_TITLE = "217. Storm Atoll",
	LEVEL_218_HISTORY = "With the Lord of the Sea by our side, we have prevailed in battle! However, the Deep Devils may yet have the last laugh: they have awakened Leviathan, the evil deity of the depths they worship. If Leviathan attains its full power, there is nothing in the world that can stop it. No time to regroup or recover, we must head into Leviathan's lair, the city of Ryly'eh, once the seat of Regnos' rule. It is time to defeat the Deep Devils and their malevolent god once and for all!",
	LEVEL_218_TITLE = "218. The Sunken Citadel",
	LEVEL_219_HISTORY = "An endless night is upon us! Something wicked has awakened, plunging the area into darkness! Mindless horrors prowl the land in search of human prey! Our King has tasked you with protecting the defenseless villagers and finding out what is causing this blight... the realm needs you!",
	LEVEL_219_TITLE = "219. Bonesburg",
	LEVEL_220_HISTORY = "We've freed Bonesburg and chased these nefarious beings to an eerie forest. Can you feel the malice radiating from it? Twisted, gnarled trees house dark altars, stages for forbidden rites. Dark horrors prowl the shadows, battle is upon us!",
	LEVEL_220_TITLE = "220. Desecrated Grove",
	LEVEL_221_HISTORY = "Deep in the black heart of the forest, we've found the root of this evil. Vasile has risen from his slumber! Vasile once more wields his dark power! Vasile, the ancient vampire prince long thought vanquished! From his mansion, this ancestral foe commands his army of darkness, hoping to turn your troops into a vampiric legion in his thrall. Let us shed light over this darkness, and end this dark night... for Linirea!",
	LEVEL_221_TITLE = "221. Dusk Chateau",
	LEVEL_222_HISTORY = "The Dwarves are one of our staunchest allies, and our King has named them Guardians of the Caves. In their quest for the Lost Kingdom of Loria, they have stumbled upon a network of secret Saurian tunnels. Through them, an enormous horde of Saurians is heading for the surface, bent on conquering Linirea under the taloned foot of Xyzzy, the Saurian King. You must join the Dwarves in stopping Xyzzy and his beasts... for only Denas can be King of Linirea!",
	LEVEL_222_TITLE = "222. Darklight Depths",
	LEVEL_301_HISTORY = "General, a band of Gnolls approaches! They are beasts who only think about looting and burning everything in their wake, but they will be sorry they ever left their arid hills... For the Queen!",
	LEVEL_301_TITLE = "301. Gray Ravens",
	LEVEL_302_HISTORY = "That Gnoll forward patrol was barely a practice fight. Our scouts have spotted a much larger band trying to cross the Old Bridge. We shall send them running back to their warrens, their numbers be damned!",
	LEVEL_302_TITLE = "302. The High Cross",
	LEVEL_303_HISTORY = "The massive enemy force crossing downriver has tried to flank us as we expected, General. We will be able to ambush the Gnolls and their beasts in the winding paths between the waterfalls. May the goddess Elynie bless us!",
	LEVEL_303_TITLE = "303. Waterfalls Trail",
	LEVEL_304_HISTORY = "The Gnoll hills must be empty, because it looks like every single one of those vile creatures has come to invade our lands! We have fought without rest, defeating one band after another, but a larger force aims to destroy the Great Redwood. The treefolk are fighting valiantly to defend their home, but they are barely holding... we must rush to their aid!",
	LEVEL_304_TITLE = "304. Redwood Stand",
	LEVEL_305_HISTORY = "Dreadful news, General! The capital has fallen! Enemy armies have attacked from every direction, razing everything in their path. Only the Bladesingers fight on, buying time for the Queen's daughter to escape to the gardens. By the Light, we must protect Princess Alleria!",
	LEVEL_305_TITLE = "305. Royal Gardens",
	LEVEL_306_HISTORY = "Malicia, queen of the Twilight Elves is in command of this bloody invasion. She has sent the entire Gnoll horde to kill Alleria, the last of Elynie's lineage. They surround us and we can hear their inhuman howls echo through the Gryphon Peak plateaus. General, we must resist at all costs, until the young princess can escape safely to Linirea!",
	LEVEL_306_TITLE = "306. Gryphon Point",
	LEVEL_307_HISTORY = "War rages on, we attack and retreat, making the invader pay a steep price for each inch of ground we give up. As per your orders, General, we've retreated into the Faery Forest, the archdruids of Rockhenge have always been our allies. Nevertheless, we can feel hidden, hostile gazes as we make our way through this magical land.",
	LEVEL_307_TITLE = "307. Rockhenge",
	LEVEL_308_HISTORY = "The fearsome Forest Keepers will fight on our side, but some of the fae have joined our enemies and our troops are nervously wondering what those approaching frumious sounds are... Praised be Elynie, one of our elite archer groups of Golden Longbows has managed to get through the enemy lines and are holding down a position among the enchanted houses of Grimmsburg. General, they need our help now!",
	LEVEL_308_TITLE = "308. Grimmsburg",
	LEVEL_309_HISTORY = "Our druidic allies feel uneasy about crossing the Crystal Lake, I have heard them whisper about the Grootslang, but they refuse to speak further about the issue. We have sent scouts to find the High Elven Mages, who study the magic of the crystals; we hope by the Light to find them in time! Our enemies are closing in, it's time to double our march and reach the Unseelie Court before our strength wanes.",
	LEVEL_309_TITLE = "309. The Crystal Lake",
	LEVEL_310_HISTORY = "Although we have weathered dozens of onslaughts, we are on the verge of collapse. We press on, towards Neverwonder, which is under the Weirdwoods' protection. If these impressive beings see us as a threat, we will be hopelessly crushed. The time has come to risk it all, may Elynie protect us.",
	LEVEL_310_TITLE = "310. Neverwonder",
	LEVEL_311_HISTORY = "No hope left for the Elves, we will find neither safe haven nor resting place at the Unseelie Court. Our enemies have taken the palace and Malicia has crowned herself Unseelie Queen. We are trapped, outnumbered and exhausted... no option left but to fight until our last breath, before we go to Elynie's embrace... Here they come, General, this will be a battle remembered throughout the ages!",
	LEVEL_311_TITLE = "311. The Unseelie Court",
	LEVEL_312_HISTORY = "We are still amazed at how deep the evil we face runs. None less than Mactans, one of the Ancient Spider Queens. General, the scouts you sent followed Malicia's and Mactans' trail. They have fled to the awe-inspiring floating ruins of the First City, where our race originated from and where no Elf has set foot in centuries. A massive Twilight army awaits us there... no time to catch our breath, the goddess Elynie herself might be in peril!",
	LEVEL_312_TITLE = "312. The Ascent",
	LEVEL_313_HISTORY = "The City and its debris float in the shape of the most dangerous stairway imaginable. Our enemies retreat into the heart of the City while we doggedly pursue them across deadly chasms. We do not know why they have decided to go around the Arcane Council area. It might be a trap, but it is our only chance to recover some ground. There is an ominous silence blanketing the place, as if even the birds fear awakening something...",
	LEVEL_313_TITLE = "313. Arcane Quarters",
	LEVEL_314_HISTORY = "The Twilight Elves are ambushing at every opportunity and the path towards the center of the City has been spattered by dead bodies... ours and theirs. Taking this pathway of small floortiles levitating over the void was a risky decision, General, but a wise one. The lair of Mactans herself lays ahead. Our troops are exhausted, but they are committed to end the existence of this abomination tainting our sacred ruins!",
	LEVEL_314_TITLE = "314. Mactans' Retreat",
	LEVEL_315_HISTORY = "General, enemy armies have been deployed around our goddess' statue. While we speak, Mactans and Malicia unleash their power to take possession of the powerful Tear of Elynie. The place is brimming with the ancient power that gave birth to our race giving our tired soldiers renewed strength. We are ready to face this last battle, the fate of our goddess and our race depends on our victory. For the Light! For Elynie!",
	LEVEL_315_TITLE = "315. Shrine of Elynie",
	LEVEL_316_HISTORY = "General, we have arrived at the border of Ogres' Fief. Gnoll tribes led by mysterious ogres are overrunning the few troops still defending the ruined wall. Time is of the essence general, we must rush to their aid!",
	LEVEL_316_TITLE = "316. Galadrian's Wall",
	LEVEL_317_HISTORY = "This is where the Ogres extract the corrupted mineral that feeds their sorcery. We can weaken their warlocks if we manage to cut off their supply of bloodsydian. General, we must also fight to free all the slaves!",
	LEVEL_317_TITLE = "317. Blood Quarry",
	LEVEL_318_HISTORY = "The ogres and their gnoll allies have retreated to the village of their cruel king, Bram the Beheader. This will be a terrible fight with no quarter, General. This is our chance to end the ogre menace to our lands once and for all. For the Kingdom!",
	LEVEL_318_TITLE = "318. Beheader's Seat",
	LEVEL_319_HISTORY = "General, we must advance without delay to the Twilight Elves' capital. Malicia's last loyal lieutenant is preparing a terrible and powerful spell that will destroy everything in sight. If we don't stop him this will be the end of the continent!",
	LEVEL_319_TITLE = "319. Duskwood Outpost",
	LEVEL_320_HISTORY = "This is the final push, General! We have routed enough enemy troops to march upon the city gates. Baj'Nimen has no other choice but to come out and fight. This will be our chance to stop his plans before it's too late.",
	LEVEL_320_TITLE = "320. Duredhel Outskirts",
	LEVEL_321_HISTORY = "War is over or so we thought... Because even as our Kingdom goes back to its former peace and prosperity, the messengers we sent asking for aid from the Dwarves never returned. And if there's something more troublesome than a loud dwarf, it's a silent one. You must travel to their land and seek answers.",
	...
	ENEMY_GREENMUCK_NAME = "Greenmuck",
	...
	ENEMY_ROTTEN_TREE_BOSS_NAME = "Lord of the Treants",
	...
	ENEMY_SAURIAN_KING_NAME = "Son of Xyzzy",
