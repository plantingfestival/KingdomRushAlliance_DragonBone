return {
	...
	HERO_WUKONG_ULTIMATE_DESCRIPTION_1 = "The White Dragon bursts into the ground with tremendous force, dealing %$heroes.hero_wukong.ultimate.damage_total[2]%$ true damage and leaving a slowing area lasting %$heroes.hero_wukong.ultimate.slow_duration[2]%$s. %$heroes.hero_wukong.ultimate.cooldown[2]%$s cooldown.",
	HERO_WUKONG_ULTIMATE_DESCRIPTION_2 = "The White Dragon bursts into the ground with tremendous force, dealing %$heroes.hero_wukong.ultimate.damage_total[3]%$ true damage and leaving a slowing area lasting %$heroes.hero_wukong.ultimate.slow_duration[3]%$s. %$heroes.hero_wukong.ultimate.cooldown[3]%$s cooldown.",
	HERO_WUKONG_ULTIMATE_DESCRIPTION_3 = "The White Dragon bursts into the ground with tremendous force, dealing %$heroes.hero_wukong.ultimate.damage_total[4]%$ true damage and leaving a slowing area lasting %$heroes.hero_wukong.ultimate.slow_duration[4]%$s. %$heroes.hero_wukong.ultimate.cooldown[4]%$s cooldown.",
