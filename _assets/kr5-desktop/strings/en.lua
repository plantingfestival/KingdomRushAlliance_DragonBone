return {
	...
	TOWER_OGRES_BARRACK_LVL4_MUSKET_RAGE_1_DESCRIPTION = "Every %$towers.ogres.musket_rage.cooldowns[1]%$ seconds, the Musket fires a burst of bullets that deal 15 physical damage each.",
	TOWER_OGRES_BARRACK_LVL4_MUSKET_RAGE_2_NAME = "Musket Rage",
	TOWER_OGRES_BARRACK_LVL4_MUSKET_RAGE_2_DESCRIPTION = "Every %$towers.ogres.musket_rage.cooldowns[2]%$ seconds, the Musket fires a burst of bullets that deal 30 physical damage each.",
