return {
	...
	HERO_VBEASTMASTER_NAME = "Cronan",
	ITEM_HERO_VBEASTMASTER_NAME = "Cronan",
	ITEM_HERO_VBEASTMASTER_BOTTOM_DESC = "Summon Cronan to defeat your enemies.",
	ITEM_HERO_VBEASTMASTER_BOTTOM_INFO = "Summon Cronan to fight alongside you.",
	ITEM_HERO_VBEASTMASTER_DESC = "Sons of the Wild, King of the Jungle! He fought tirelessly against the harsh environment known to man, and his whip tamed all fierce and bloodthirsty beasts! His will is filled with the unstoppable wrath of nature!",
