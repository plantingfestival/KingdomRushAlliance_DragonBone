return {
	...
	TOWER_DEEP_DEVILS_4_STORM_1_DESCRIPTION = "Summons a cloud over an enemy, and it deals up to 125 magical damage in 5 seconds. %$towers.deep_devils_reef.storm.cooldown%$s cooldown.",
	TOWER_DEEP_DEVILS_4_STORM_2_DESCRIPTION = "Summons a cloud over an enemy, and it deals up to 250 magical damage in 5 seconds. %$towers.deep_devils_reef.storm.cooldown%$s cooldown.",
	TOWER_DEEP_DEVILS_4_STORM_3_DESCRIPTION = "Summons a cloud over an enemy, and it deals up to 375 magical damage in 5 seconds. %$towers.deep_devils_reef.storm.cooldown%$s cooldown.",
