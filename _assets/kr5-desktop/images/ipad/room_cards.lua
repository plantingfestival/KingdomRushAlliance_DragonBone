...
return {
	...
	CardFx_asst_white_overlay_blur = {
		...
		alias = {
			"CardSpawn_asst_white_overlay_blur"
		}
	},
	CardSpawn_asst_card_white = {
		a_name = "room_cards-9.png",
		defer = true,
		size = {
			531,
			492
